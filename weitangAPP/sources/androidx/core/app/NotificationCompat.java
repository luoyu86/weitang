...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            private Builder(int i2, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, boolean z, int i3, boolean z2) {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            if (!z || (arrayList = this.mBuilder.mActions) == null || (iMin = Math.min(arrayList.size(), 3)) <= 0) {
                z2 = false;
            } else {
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        int i3 = Build.VERSION.SDK_INT;
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, null, i3 >= 24 ? action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES) || action.getAllowGeneratedReplies() : action.getExtras().getBoolean(NotificationCompatJellybean.EXTRA_ALLOW_GENERATED_REPLIES), i3 >= 28 ? action.getSemanticAction() : action.getExtras().getInt(Action.EXTRA_SEMANTIC_ACTION, 0), action.getExtras().getBoolean(Action.EXTRA_SHOWS_USER_INTERFACE, true));
    }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i2 >= 24) {
                ...
                if (this.mIsGroupConversation.booleanValue() || i2 >= 28) {
