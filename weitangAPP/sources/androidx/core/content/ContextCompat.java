    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (i2 > 21) {
                ...
                map.put(CameraManager.class, d.SOURCE_TYPE_CAMERA);
            ...
            if (i2 > 19) {
                ...
                map.put(PrintManager.class, PDWindowsLaunchParams.OPERATION_PRINT);
            }
            if (i2 > 18) {
            ...
            if (i2 > 16) {
                map.put(InputManager.class, ScoresBean.SCORE_TYPE_INPUT);
            ...
            map.put(TelephonyManager.class, NewLoginBo.SMS_LOGIN_NAME);
            ...
            map.put(WifiManager.class, UtilityImpl.NET_TYPE_WIFI);
