...
public class PrecomputedTextCompat implements Spannable {
    ...
    public int getParagraphEnd(@IntRange(from = 0) int i2) {
        ...
        return Build.VERSION.SDK_INT >= 28 ? this.mWrapped.getParagraphEnd(i2) : this.mParagraphEnds[i2];
    }
    ...
    public <T> T[] getSpans(int i2, int i3, Class<T> cls) {
        return Build.VERSION.SDK_INT >= 28 ? (T[]) this.mWrapped.getSpans(i2, i3, cls) : (T[]) this.mText.getSpans(i2, i3, cls);
    }
    ...
    public static final class Params {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            int i2 = Build.VERSION.SDK_INT;
            if (i2 >= 23 && (this.mBreakStrategy != params.getBreakStrategy() || this.mHyphenationFrequency != params.getHyphenationFrequency())) {
                return false;
            }
            if ((i2 >= 18 && this.mTextDir != params.getTextDirection()) || this.mPaint.getTextSize() != params.getTextPaint().getTextSize() || this.mPaint.getTextScaleX() != params.getTextPaint().getTextScaleX() || this.mPaint.getTextSkewX() != params.getTextPaint().getTextSkewX()) {
                return false;
            }
