...
public abstract class FragmentTransaction {
    ...
    @NonNull
    public abstract FragmentTransaction add(@IdRes int i2, @NonNull Fragment fragment);

    @NonNull
    public abstract FragmentTransaction add(@IdRes int i2, @NonNull Fragment fragment, @Nullable String str);
    ...
    @NonNull
    public abstract FragmentTransaction replace(@IdRes int i2, @NonNull Fragment fragment);

    @NonNull
    public abstract FragmentTransaction replace(@IdRes int i2, @NonNull Fragment fragment, @Nullable String str);
