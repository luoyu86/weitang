...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    */
    ...
    public void restoreAllState(Parcelable parcelable, FragmentManagerNonConfig fragmentManagerNonConfig) {
        ...
        while (true) {
            ...
            if (fragmentState2 != null) {
                Fragment fragmentInstantiate = fragmentState2.instantiate(this.mHost, this.mContainer, this.mParent, (childNonConfigs == null || i4 >= childNonConfigs.size()) ? null : childNonConfigs.get(i4), (viewModelStores == null || i4 >= viewModelStores.size()) ? null : viewModelStores.get(i4));
                if (DEBUG) {
        ...
        if (fragmentManagerState.mAdded != null) {
            ...
            while (true) {
                ...
                Fragment fragment4 = this.mActive.get(iArr[i7]);
                if (fragment4 == null) {
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            while (true) {
                ...
                BackStackRecord backStackRecordInstantiate = backStackStateArr[i8].instantiate(this);
                if (DEBUG) {
                    Log.v("FragmentManager", "restoreAllState: back stack #" + i8 + " (index " + backStackRecordInstantiate.mIndex + "): " + backStackRecordInstantiate);
                    PrintWriter printWriter = new PrintWriter(new LogWriter("FragmentManager"));
                    backStackRecordInstantiate.dump("  ", printWriter, false);
                    printWriter.close();
                }
                this.mBackStack.add(backStackRecordInstantiate);
                int i9 = backStackRecordInstantiate.mIndex;
                if (i9 >= 0) {
                    setBackStackIndex(i9, backStackRecordInstantiate);
                }
                i8++;
            }
        } else {
        ...
        if (i10 >= 0) {
            this.mPrimaryNav = this.mActive.get(i10);
        }
    ...
    public Parcelable saveAllState() {
            ...
            if (fragmentValueAt != null) {
                ...
                if (fragmentValueAt.mState <= 0 || fragmentState.mSavedFragmentState != null) {
                    ...
                    if (fragment != null) {
                        ...
                        int i3 = fragmentValueAt.mTargetRequestCode;
                        if (i3 != 0) {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                if (DEBUG) {
                    Log.v("FragmentManager", "saveAllState: adding back stack #" + i5 + ": " + this.mBackStack.get(i5));
                }
            }
        }
    ...
    private boolean popBackStackImmediate(String str, int i2, int i3) {
        ...
        if (fragment != null && i2 < 0 && str == null && (fragmentManagerPeekChildFragmentManager = fragment.peekChildFragmentManager()) != null && fragmentManagerPeekChildFragmentManager.popBackStackImmediate()) {
            return true;
        }
        ...
        if (z || i2 != this.mCurState) {
            ...
            if (this.mActive != null) {
                ...
                for (int i4 = 0; i4 < size2; i4++) {
                    Fragment fragmentValueAt = this.mActive.valueAt(i4);
