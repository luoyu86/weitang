...
public interface ObservableList<T> extends List<T> {
    ...
    public static abstract class OnListChangedCallback<T extends ObservableList> {
        ...
        public abstract void onItemRangeChanged(T t, int i2, int i3);

        public abstract void onItemRangeInserted(T t, int i2, int i3);

        public abstract void onItemRangeMoved(T t, int i2, int i3, int i4);

        public abstract void onItemRangeRemoved(T t, int i2, int i3);
    }
