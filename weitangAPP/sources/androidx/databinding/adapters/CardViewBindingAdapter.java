...
public class CardViewBindingAdapter {
    ...
    public static void setContentPadding(CardView cardView, int i2) {
        cardView.setContentPadding(i2, i2, i2, i2);
    }

    @BindingAdapter({"contentPaddingBottom"})
    public static void setContentPaddingBottom(CardView cardView, int i2) {
    ...
    public static void setContentPaddingLeft(CardView cardView, int i2) {
    ...
    public static void setContentPaddingRight(CardView cardView, int i2) {
    ...
    public static void setContentPaddingTop(CardView cardView, int i2) {
