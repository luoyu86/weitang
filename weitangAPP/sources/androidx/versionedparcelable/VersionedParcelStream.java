...
public class VersionedParcelStream extends VersionedParcel {
    ...
    public static class InputBuffer {
        ...
        public InputBuffer(int i2, int i3, DataInputStream dataInputStream) throws IOException {
            this.mSize = i3;
            this.mFieldId = i2;
    ...
    public boolean readField(int i2) {
        InputBuffer inputBuffer = this.mCachedFields.get(i2);
        if (inputBuffer != null) {
            this.mCachedFields.remove(i2);
        ...
        while (true) {
            try {
                ...
                InputBuffer inputBuffer2 = new InputBuffer((i3 >> 16) & 65535, i4, this.mMasterInput);
                int i5 = inputBuffer2.mFieldId;
                if (i5 == i2) {
                    this.mCurrentInput = inputBuffer2.mInputStream;
                    return true;
                }
                this.mCachedFields.put(i5, inputBuffer2);
