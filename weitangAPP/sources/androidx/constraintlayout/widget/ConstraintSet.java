    ...
    private String sideToString(int i2) {
        switch (i2) {
            ...
            case 5:
                return "baseline";
            case 6:
                return RequestBannerParamBo.GET_SPLASH_TYPE;
            case 7:
                return "end";
            default:
                return "undefined";
                ...
                if (i3 != -1 && i3 == 1) {
                    ...
                    if (iArr != null) {
                        ...
                        if (str != null) {
                            ...
                            constraint.mReferenceIds = iArrConvertReferenceString;
        ...
        for (Integer num : hashSet) {
            ...
            if (i5 != -1 && i5 == 1) {
                ...
                if (iArr2 != null) {
                    ...
                    if (str2 != null) {
                        int[] iArrConvertReferenceString2 = convertReferenceString(barrier2, str2);
                        constraint2.mReferenceIds = iArrConvertReferenceString2;
