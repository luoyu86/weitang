        ...
        if (constraintWidget != null && ((ConstraintWidgetContainer) constraintWidget).optimizeFor(2)) {
            ...
            for (int i5 = 0; i5 < this.mWidgetsCount; i5++) {
                ...
                if (this.mAllowsGoneWidget || constraintWidget2.allowedInBarrier()) {
                    ...
                    ResolutionAnchor resolutionNode2 = i6 != 0 ? i6 != 1 ? i6 != 2 ? i6 != 3 ? null : constraintWidget2.mBottom.getResolutionNode() : constraintWidget2.mTop.getResolutionNode() : constraintWidget2.mRight.getResolutionNode() : constraintWidget2.mLeft.getResolutionNode();
