...
public class LinearSystem {
    ...
    public static ArrayRow createRowDimensionPercent(LinearSystem linearSystem, SolverVariable solverVariable, SolverVariable solverVariable2, SolverVariable solverVariable3, float f2, boolean z) {
        ...
        return arrayRowCreateRow.createRowDimensionPercent(solverVariable, solverVariable2, solverVariable3, f2);
    }
    ...
    public void addGreaterThan(SolverVariable solverVariable, int i2) {
        ...
        SolverVariable solverVariableCreateSlackVariable = createSlackVariable();
        solverVariableCreateSlackVariable.strength = 0;
        arrayRowCreateRow.createRowGreaterThan(solverVariable, i2, solverVariableCreateSlackVariable);
        addConstraint(arrayRowCreateRow);
    }
    ...
    public void addEquality(SolverVariable solverVariable, int i2, int i3) {
        ...
        ArrayRow arrayRowCreateRow2 = createRow();
        arrayRowCreateRow2.createRowDefinition(solverVariable, i2);
        arrayRowCreateRow2.addError(this, i3);
        addConstraint(arrayRowCreateRow2);
    }
}
