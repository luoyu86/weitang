...
public abstract class Transition implements Cloneable {
    ...
    private static int[] parseMatchOrder(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if ("id".equalsIgnoreCase(strTrim)) {
                ...
                if (!strTrim.isEmpty()) {
                    throw new InflateException("Unknown match type in matchOrder: '" + strTrim + OperatorName.SHOW_TEXT_LINE);
                }
    ...
    */
    ...
    public Transition(Context context, AttributeSet attributeSet) {
        ...
        long namedInt = TypedArrayUtils.getNamedInt(typedArrayObtainStyledAttributes, xmlResourceParser, MediationConstant.EXTRA_DURATION, 1, -1);
        if (namedInt >= 0) {
