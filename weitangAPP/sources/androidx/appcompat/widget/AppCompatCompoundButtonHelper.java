...
public class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i2) {
        int resourceId;
        TypedArray typedArrayObtainStyledAttributes = this.mView.getContext().obtainStyledAttributes(attributeSet, R.styleable.CompoundButton, i2, 0);
        try {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(i4)) {
                CompoundButtonCompat.setButtonTintList(this.mView, typedArrayObtainStyledAttributes.getColorStateList(i4));
            }
            int i5 = R.styleable.CompoundButton_buttonTintMode;
            if (typedArrayObtainStyledAttributes.hasValue(i5)) {
                CompoundButtonCompat.setButtonTintMode(this.mView, DrawableUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(i5, -1), null));
            }
        } finally {
