...
public class AppCompatTextViewAutoSizeHelper {
    ...
    private StaticLayout createStaticLayoutForMeasuring(CharSequence charSequence, Layout.Alignment alignment, int i2, int i3) {
        ...
        StaticLayout.Builder hyphenationFrequency = StaticLayout.Builder.obtain(charSequence, 0, charSequence.length(), this.mTempTextPaint, i2).setAlignment(alignment).setLineSpacing(this.mTextView.getLineSpacingExtra(), this.mTextView.getLineSpacingMultiplier()).setIncludePad(this.mTextView.getIncludeFontPadding()).setBreakStrategy(this.mTextView.getBreakStrategy()).setHyphenationFrequency(this.mTextView.getHyphenationFrequency());
        if (i3 == -1) {
    ...
    private StaticLayout createStaticLayoutForMeasuringPre23(CharSequence charSequence, Layout.Alignment alignment, int i2) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            zBooleanValue = ((Boolean) invokeAndReturnWithDefault(this.mTextView, "getIncludeFontPadding", Boolean.TRUE)).booleanValue();
        }
        return new StaticLayout(charSequence, this.mTempTextPaint, i2, alignment, fFloatValue, fFloatValue2, zBooleanValue);
    }
    ...
    private boolean suggestedSizeFitsInSpace(int i2, RectF rectF) {
        ...
        int maxLines = i3 >= 16 ? this.mTextView.getMaxLines() : -1;
        ...
        StaticLayout staticLayoutCreateStaticLayoutForMeasuring = i3 >= 23 ? createStaticLayoutForMeasuring(text, alignment, Math.round(rectF.right), maxLines) : createStaticLayoutForMeasuringPre23(text, alignment, Math.round(rectF.right));
