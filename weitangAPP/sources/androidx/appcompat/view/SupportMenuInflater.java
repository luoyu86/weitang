    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(i2)) {
                this.itemCheckable = typedArrayObtainStyledAttributes.getBoolean(i2, false) ? 1 : 0;
            } else {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(i3)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(i3, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i4 = R.styleable.MenuItem_iconTint;
            if (typedArrayObtainStyledAttributes.hasValue(i4)) {
                this.itemIconTintList = typedArrayObtainStyledAttributes.getColorStateList(i4);
            } else {
