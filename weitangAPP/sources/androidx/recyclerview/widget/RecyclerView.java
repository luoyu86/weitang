...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), WXVideoFileObject.FILE_SIZE_LIMIT), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), WXVideoFileObject.FILE_SIZE_LIMIT));
        }
        ...
        public void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = WXVideoFileObject.FILE_SIZE_LIMIT;
            this.mHeightMode = WXVideoFileObject.FILE_SIZE_LIMIT;
        }
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i2) {
            ...
            tryBindViewHolderByDeadline(childViewHolderInt, iFindPositionOffset, i2, RecyclerView.FOREVER_NS);
  ...
  0x0186: PHI (r1v12 androidx.recyclerview.widget.RecyclerView$ViewHolder) = 
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public void runIfNecessary(RecyclerView recyclerView) {
                ...
                int i4 = this.mConsecutiveUpdates + 1;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            ...
            if (this.mLayout.shouldMeasureTwice()) {
                this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), WXVideoFileObject.FILE_SIZE_LIMIT), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), WXVideoFileObject.FILE_SIZE_LIMIT));
                this.mState.mIsMeasuring = true;
                dispatchLayoutStep2();
                this.mLayout.setMeasuredDimensionFromChildren(i2, i3);
                return;
