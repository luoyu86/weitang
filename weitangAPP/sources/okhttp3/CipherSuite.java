...
public final class CipherSuite {
    ...
    static {
        ...
        TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = of("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", TTDownloadField.CALL_DOWNLOAD_MODEL_SET_ID);
        TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA = of("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", TTDownloadField.CALL_DOWNLOAD_MODEL_SET_LOG_EXTRA);
        TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA = of("TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA", TTDownloadField.CALL_DOWNLOAD_MODEL_SET_PACKAGE_NAME);
        TLS_PSK_WITH_RC4_128_SHA = of("TLS_PSK_WITH_RC4_128_SHA", TTDownloadField.CALL_DOWNLOAD_MODEL_SET_DEEP_LINK);
        TLS_PSK_WITH_3DES_EDE_CBC_SHA = of("TLS_PSK_WITH_3DES_EDE_CBC_SHA", TTDownloadField.CALL_DOWNLOAD_MODEL_SET_CLICK_TRACK_URL);
        TLS_PSK_WITH_AES_128_CBC_SHA = of("TLS_PSK_WITH_AES_128_CBC_SHA", TTDownloadField.CALL_DOWNLOAD_MODEL_SET_DOWNLOAD_URL);
        TLS_PSK_WITH_AES_256_CBC_SHA = of("TLS_PSK_WITH_AES_256_CBC_SHA", TTDownloadField.CALL_DOWNLOAD_MODEL_SET_BACKUP_URLS);
        TLS_RSA_WITH_SEED_CBC_SHA = of("TLS_RSA_WITH_SEED_CBC_SHA", TTDownloadField.CALL_DOWNLOAD_MODEL_SET_VERSION_NAME);
