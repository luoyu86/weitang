...
public final class CertificatePinner {
    ...
    public static f sha1(X509Certificate x509Certificate) {
        return f.of(x509Certificate.getPublicKey().getEncoded()).sha1();
    }

    public static f sha256(X509Certificate x509Certificate) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                if (pin.hashAlgorithm.equals("sha256/")) {
                    if (fVarSha256 == null) {
                        fVarSha256 = sha256(x509Certificate);
                    }
                    if (pin.hash.equals(fVarSha256)) {
                        return;
                    }
                } else {
                    ...
                    if (fVarSha1 == null) {
                        fVarSha1 = sha1(x509Certificate);
                    }
                    if (pin.hash.equals(fVarSha1)) {
                        return;
                    }
                }
            }
