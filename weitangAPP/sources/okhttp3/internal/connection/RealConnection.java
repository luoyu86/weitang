...
public final class RealConnection extends Http2Connection.Listener implements Connection {
            ...
            try {
                ...
                try {
                    ...
                    if (address.hostnameVerifier().verify(address.url().host(), session)) {
                        ...
                        this.source = l.buffer(l.source(sSLSocket2));
    ...
    private Request createTunnel(int i2, int i3, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            t tVarNewFixedLengthSource = http1Codec.newFixedLengthSource(jContentLength);
            Util.skipAll(tVarNewFixedLengthSource, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, timeUnit);
            tVarNewFixedLengthSource.close();
            ...
            if (ILivePush.ClickType.CLOSE.equalsIgnoreCase(responseBuild.header("Connection"))) {
    ...
    */
    ...
    public HttpCodec newCodec(OkHttpClient okHttpClient, Interceptor.Chain chain, StreamAllocation streamAllocation) throws SocketException {
        ...
        u uVarTimeout = this.source.timeout();
        long timeoutMillis = chain.readTimeoutMillis();
        TimeUnit timeUnit = TimeUnit.MILLISECONDS;
        uVarTimeout.timeout(timeoutMillis, timeUnit);
