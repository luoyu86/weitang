...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        s sVarBody;
        if (cacheRequest == null || (sVarBody = cacheRequest.body()) == null) {
            return response;
        }
        final e eVarSource = response.body().source();
        final d dVarBuffer = l.buffer(sVarBody);
        return response.newBuilder().body(new RealResponseBody(response.header("Content-Type"), response.body().contentLength(), l.buffer(new t() { // from class: okhttp3.internal.cache.CacheInterceptor.1
            ...
            public long read(c cVar, long j) throws IOException {
                try {
                    ...
                    if (j2 != -1) {
                        cVar.copyTo(dVarBuffer.buffer(), cVar.size() - j2, j2);
