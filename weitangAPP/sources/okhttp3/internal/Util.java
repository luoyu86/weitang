...
public final class Util {
    ...
    private static final f UTF_8_BOM = f.decodeHex("efbbbf");
    private static final f UTF_16_BE_BOM = f.decodeHex("feff");
    private static final f UTF_16_LE_BOM = f.decodeHex("fffe");
    private static final f UTF_32_BE_BOM = f.decodeHex("0000ffff");
    private static final f UTF_32_LE_BOM = f.decodeHex("ffff0000");
    ...
    public static Charset bomAwareCharset(e eVar, Charset charset) throws IOException {
        if (eVar.rangeEquals(0L, UTF_8_BOM)) {
            eVar.skip(r0.size());
            return UTF_8;
        }
        if (eVar.rangeEquals(0L, UTF_16_BE_BOM)) {
            eVar.skip(r0.size());
            return UTF_16_BE;
        }
        if (eVar.rangeEquals(0L, UTF_16_LE_BOM)) {
            eVar.skip(r0.size());
            return UTF_16_LE;
        }
        if (eVar.rangeEquals(0L, UTF_32_BE_BOM)) {
            eVar.skip(r0.size());
            return UTF_32_BE;
        }
        if (!eVar.rangeEquals(0L, UTF_32_LE_BOM)) {
            return charset;
        }
        eVar.skip(r0.size());
        return UTF_32_LE;
    ...
    */
    ...
    public static boolean discard(t tVar, int i2, TimeUnit timeUnit) {
        try {
            return skipAll(tVar, i2, timeUnit);
    ...
    public static boolean skipAll(t tVar, int i2, TimeUnit timeUnit) throws IOException {
        long jNanoTime = System.nanoTime();
        long jDeadlineNanoTime = tVar.timeout().hasDeadline() ? tVar.timeout().deadlineNanoTime() - jNanoTime : Long.MAX_VALUE;
        tVar.timeout().deadlineNanoTime(Math.min(jDeadlineNanoTime, timeUnit.toNanos(i2)) + jNanoTime);
        try {
            c cVar = new c();
            ...
            if (jDeadlineNanoTime == RecyclerView.FOREVER_NS) {
                ...
                tVar.timeout().deadlineNanoTime(jNanoTime + jDeadlineNanoTime);
            }
            return true;
