...
public class Huffman {
    ...
    public void encode(f fVar, d dVar) throws IOException {
        long j = 0;
        int i2 = 0;
        for (int i3 = 0; i3 < fVar.size(); i3++) {
            int i4 = fVar.getByte(i3) & 255;
            int i5 = CODES[i4];
        ...
        if (i2 > 0) {
            dVar.writeByte((int) (((long) (255 >>> i2)) | (j << (8 - i2))));
        }
    }
    ...
    public int encodedLength(f fVar) {
        ...
        for (int i2 = 0; i2 < fVar.size(); i2++) {
            j += (long) CODE_LENGTHS[fVar.getByte(i2) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
