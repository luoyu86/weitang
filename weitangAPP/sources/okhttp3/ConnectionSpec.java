...
public final class ConnectionSpec {
    ...
    static {
        ...
        RESTRICTED_TLS = builderCipherSuites.tlsVersions(tlsVersion).supportsTlsExtensions(true).build();
        Builder builderCipherSuites2 = new Builder(true).cipherSuites(cipherSuiteArr2);
        TlsVersion tlsVersion2 = TlsVersion.TLS_1_0;
        ConnectionSpec connectionSpecBuild = builderCipherSuites2.tlsVersions(tlsVersion, TlsVersion.TLS_1_1, tlsVersion2).supportsTlsExtensions(true).build();
        MODERN_TLS = connectionSpecBuild;
        COMPATIBLE_TLS = new Builder(connectionSpecBuild).tlsVersions(tlsVersion2).supportsTlsExtensions(true).build();
