...
public class Flags implements Cloneable, Serializable {
    ...
    public boolean retainAll(Flags flags) {
        ...
        int i3 = flags.system_flags & i2;
        if (i2 != i3) {
            this.system_flags = i3;
            z = true;
        } else {
            z = false;
        }
        ...
        while (enumerationKeys.hasMoreElements()) {
            ...
            if (!flags.user_flags.containsKey(strNextElement)) {
    ...
    public void add(Flags flags) {
        ...
        if (flags.user_flags != null) {
            ...
            Enumeration<String> enumerationKeys = flags.user_flags.keys();
            while (enumerationKeys.hasMoreElements()) {
                String strNextElement = enumerationKeys.nextElement();
                this.user_flags.put(strNextElement, flags.user_flags.get(strNextElement));
            }
        }
    }
