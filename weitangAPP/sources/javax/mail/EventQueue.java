...
public class EventQueue implements Runnable {
    ...
    private volatile BlockingQueue<QueueElement> f14923q;
    ...
    public synchronized void enqueue(MailEvent mailEvent, Vector<? extends EventListener> vector) {
        if (this.f14923q == null) {
            this.f14923q = new LinkedBlockingQueue();
        ...
        this.f14923q.add(new QueueElement(mailEvent, vector));
    }

    @Override // java.lang.Runnable
    public void run() {
        BlockingQueue<QueueElement> blockingQueue = this.f14923q;
    ...
    public synchronized void terminateQueue() {
        if (this.f14923q != null) {
            ...
            vector.setSize(1);
            this.f14923q.add(new QueueElement(new TerminatorEvent(), vector));
            this.f14923q = null;
        }
    }
}
