...
public class SharedFileInputStream extends BufferedInputStream implements SharedInputStream {
    ...
    private void fill() throws IOException {
        ...
        long j = this.bufpos;
        long j2 = this.start;
        long j3 = (j - j2) + ((long) i6) + ((long) i7);
        long j4 = this.datalen;
        if (j3 > j4) {
            i7 = (int) (j4 - ((j - j2) + ((long) i6)));
        }
        synchronized (this.in) {
            this.in.seek(this.bufpos + ((long) ((BufferedInputStream) this).pos));
            int i8 = this.in.read(((BufferedInputStream) this).buf, ((BufferedInputStream) this).pos, i7);
            if (i8 > 0) {
                ((BufferedInputStream) this).count = i8 + ((BufferedInputStream) this).pos;
            }
        }
    }
    ...
    public static class SharedFile {
        ...
        public SharedFile(String str) throws IOException {
            this.in = new RandomAccessFile(str, PDPageLabelRange.STYLE_ROMAN_LOWER);
        }
        ...
        public SharedFile(File file) throws IOException {
            this.in = new RandomAccessFile(file, PDPageLabelRange.STYLE_ROMAN_LOWER);
        }
    }
    ...
    public synchronized int read(byte[] bArr, int i2, int i3) throws IOException {
        ...
        int i5 = read1(bArr, i2, i3);
        if (i5 <= 0) {
            return i5;
        }
        while (i5 < i3) {
            int i6 = read1(bArr, i2 + i5, i3 - i5);
            if (i6 <= 0) {
                break;
            }
            i5 += i6;
    ...
    private SharedFileInputStream(SharedFile sharedFile, long j, long j2, int i2) {
        super(null);
        this.start = 0L;
        this.master = true;
        this.master = false;
