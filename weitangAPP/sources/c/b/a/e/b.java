...
public class b {
    ...
    public static int leapMonth(int i2) {
        return (f858b[i2 - 1900] & 15728640) >> 20;
    }

    public static final int[] lunarToSolar(int i2, int i3, int i4, boolean z) {
        ...
        for (int i7 = 1; i7 < i3; i7++) {
            i6 = ((524288 >> (i7 + (-1))) & f858b[i5]) == 0 ? i6 + 29 : i6 + 30;
        }
        int i8 = i6 + i4;
        int[] iArr2 = f858b;
        int i9 = (iArr2[i5] & 15728640) >> 20;
        if (i9 != 0 && (i3 > i9 || (i3 == i9 && z))) {
            i8 = ((524288 >> (i3 - 1)) & iArr2[i5]) == 0 ? i8 + 29 : i8 + 30;
        }
        ...
        while (true) {
            ...
            if (i11 >= i8) {
                ...
                if (i8 > i14) {
                    ...
                    iArr3[2] = (iArr4[i10] - iArr4[i13]) + 1;
                } else {
                    iArr3[2] = iArr4[i10] - iArr4[i13];
                }
            } else {
                i10++;
            }
    ...
    public static final int[] solarToLunar(int i2, int i3, int i4) {
        ...
        int i7 = iArr2[i6];
        long jD = d(i2, i3, i4) - d(c(i7, 12, 9), c(i7, 4, 5), c(i7, 5, 0));
        int i8 = f860d[i6];
        int iC = c(i8, 4, 13);
        int i9 = i6 + f859c[0];
        long j = jD + 1;
    ...
    public static final int daysInMonth(int i2, int i3, boolean z) {
