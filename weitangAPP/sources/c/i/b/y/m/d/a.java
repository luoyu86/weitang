...
public class a {
    ...
    public static final TimeZone f2693a = TimeZone.getTimeZone("UTC");
    ...
    public static void c(StringBuilder sb, int i2, int i3) {
    ...
    public static int d(String str, int i2, int i3) throws NumberFormatException {
        int i4;
        int i5;
    ...
    public static String format(Date date) {
        return format(date, false, f2693a);
    }
    ...
    */
    public static java.util.Date parse(java.lang.String r17, java.text.ParsePosition r18) throws java.text.ParseException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: c.i.b.y.m.d.a.parse(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    public static String format(Date date, boolean z) {
        return format(date, z, f2693a);
    }
