...
public final class d {
    ...
    public static final TypedValue f780a = new TypedValue();

    public static String a(View view, @IdRes int i2) {
    ...
    public static <T> T castView(View view, @IdRes int i2, String str, Class<T> cls) {
        try {
            ...
            throw new IllegalStateException("View '" + a(view, i2) + "' with ID " + i2 + " for " + str + " was of the wrong type. See cause for more info.", e2);
        }
    }
    ...
    public static View findRequiredView(View view, @IdRes int i2, String str) {
        ...
        throw new IllegalStateException("Required view '" + a(view, i2) + "' with ID " + i2 + " for " + str + " was not found. If this view is optional add '@Nullable' (fields) or '@Optional' (methods) annotation.");
    }
