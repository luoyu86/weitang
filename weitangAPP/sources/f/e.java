...
public interface e extends t, ReadableByteChannel {
    ...
    boolean rangeEquals(long j, f fVar, int i2, int i3) throws IOException;
    ...
    @Override // f.t
    /* synthetic */ long read(c cVar, long j) throws IOException;

    long readAll(s sVar) throws IOException;
    ...
    int select(m mVar) throws IOException;
