...
public class a {
    ...
    private static boolean f4523a = false;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static long f4524c = 300000;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static long f4525d = 30000;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public static List<String> f4526f = new ArrayList();

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static List<String> f4527g = new ArrayList();

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public static List<String> f4528h = new ArrayList();

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public static List<String> f4529i = new ArrayList();
    public static List<String> j = new ArrayList();
    public static List<String> k = new ArrayList();
    private static String T = com.alipay.sdk.m.k.b.k;
    ...
    public static List<String> m24a(String str) {
        int i2;
        try {
        ...
        return i2 == -1 ? f4526f : (i2 == 1 || i2 == 61005 || i2 == 61006 || i2 == 65501 || i2 == 65502 || i2 == 65503 || i2 == 65133) ? f4527g : ((i2 <= 1 || i2 >= 100) && (i2 <= 15300 || i2 >= 15400) && ((i2 <= 21000 || i2 >= 30000) && ((i2 <= 61000 || i2 >= 61200) && (i2 <= 65000 || i2 >= 65300)))) ? (i2 <= 1000 || i2 >= 2100) ? (i2 <= 2100 || i2 >= 2200) ? (i2 == 19999 || (i2 > 4000 && i2 < 10000) || ((i2 > 64000 && i2 < 65000) || ((i2 > 65500 && i2 < 65600) || (i2 > 66000 && i2 < 67000)))) ? f4526f : k : j : f4529i : f4528h;
    }
    ...
    public static String h() {
        if ("l0".equalsIgnoreCase(T)) {
            i.a(Config.TAG, T, "l0 config");
            return "{\"SYSTEM\":{\"discardap\":\"1\"}}";
        }
        if ("l1".equalsIgnoreCase(T)) {
            i.a(Config.TAG, T, "l1 config");
        ...
        if ("l2".equalsIgnoreCase(T)) {
            i.a(Config.TAG, T, "l2 config");
        ...
        if ("l3".equalsIgnoreCase(T)) {
            i.a(Config.TAG, T, "l3 config");
        ...
        i.a(Config.TAG, T, "net config");
        String strA = a("b01na");
        if (strA == null) {
            return null;
        }
        try {
            JSONObject jSONObject = new JSONObject(strA).getJSONObject("content");
            if (jSONObject != null) {
