    ...
    public static List<String> getSourcePaths(Context context) throws PackageManager.NameNotFoundException, IOException {
        ...
        if (!isVMMultidexCapable()) {
            ...
            for (int i3 = 2; i3 <= i2; i3++) {
                ...
                if (!file3.isFile()) {
                    throw new IOException("Missing extracted secondary dex file '" + file3.getPath() + OperatorName.SHOW_TEXT_LINE);
                }
    ...
    private static List<String> tryLoadInstantRunDexFile(ApplicationInfo applicationInfo) {
        ...
        if (Build.VERSION.SDK_INT < 21 || (strArr = applicationInfo.splitSourceDirs) == null) {
            try {
                ...
                Log.e("ARouter::", "InstantRun support error, " + e2.getMessage());
            }
        } else {
