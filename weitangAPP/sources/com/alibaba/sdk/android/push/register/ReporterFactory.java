...
public class ReporterFactory {
    private static final String TAG = "com.alibaba.sdk.android.push.register.ReporterFactory";
    ...
    public static String addPrefix(String str, String str2) {
        for (int i2 = 0; i2 < ThirdPushManager.ThirdPushReportKeyword.values().length; i2++) {
            if (str.equals(ThirdPushManager.ThirdPushReportKeyword.values()[i2].thirdTokenKeyword)) {
                return ThirdPushManager.ThirdPushReportKeyword.values()[i2].thirdSdkVersionPrefix + str2;
            }
        }
        return str + str2;
    }
                ...
                if (mMsgReporter == null) {
                    mMsgReporter = new IMsgReporter() { // from class: com.alibaba.sdk.android.push.register.ReporterFactory.2
                        ...
                        public void sendMsgToDecryptor(Context context, String str, byte[] bArr, String str2) {
                            try {
                                AgooFactory.getInstance(context).msgRecevie(bArr, str, null);
                            } catch (Throwable th) {
                ...
                if (mTokenReporter == null) {
                    mTokenReporter = new ITokenReporterV2() { // from class: com.alibaba.sdk.android.push.register.ReporterFactory.1
                        ...
                        public void reportToken(Context context, String str, String str2, String str3) {
                            reportToken(context, BuildConfig.VERSION_NAME, str, str2, str3);
                        }
                    };
                }
            }
