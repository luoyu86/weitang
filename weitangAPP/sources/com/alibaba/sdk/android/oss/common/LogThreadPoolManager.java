...
public class LogThreadPoolManager {
    ...
    private LogThreadPoolManager() {
        ...
        this.mThreadPool = new ThreadPoolExecutor(1, 1, 5000L, timeUnit, new ArrayBlockingQueue(500), new ThreadFactory() { // from class: com.alibaba.sdk.android.oss.common.LogThreadPoolManager.2
