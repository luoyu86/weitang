...
public final class ResponseParsers {
        ...
        while (eventType != 1) {
            if (eventType == 2) {
                ...
                if (name != null) {
                    ...
                    } else if (OperatorName.BEGIN_INLINE_IMAGE_DATA.equals(name)) {
    ...
    public static DeleteMultipleObjectResult parseDeleteMultipleObjectResponse(InputStream inputStream, DeleteMultipleObjectResult deleteMultipleObjectResult) throws Exception {
        ...
        int eventType = xmlPullParserNewPullParser.getEventType();
        while (eventType != 1) {
            if (eventType == 2 && PDAnnotationText.NAME_KEY.equals(xmlPullParserNewPullParser.getName())) {
            ...
            if (eventType == 2) {
                ...
                if (name2 != null) {
                    if ("Owner".equals(name2)) {
                        owner = new Owner();
                    } else if (OperatorName.BEGIN_INLINE_IMAGE_DATA.equals(name2)) {
                        if (owner != null) {
    ...
    public static ListPartsResult parseListPartsResponseXML(InputStream inputStream, ListPartsResult listPartsResult) throws Exception {
        ...
        while (eventType != 1) {
            if (eventType == 2) {
                ...
                } else if (StandardStructureTypes.PART.equals(name)) {
            ...
            } else if (eventType == 3 && StandardStructureTypes.PART.equals(xmlPullParserNewPullParser.getName())) {
    ...
    public static ServiceException parseResponseErrorXML(ResponseMessage responseMessage, boolean z) throws ClientException {
        ...
        if (z) {
            ...
            try {
                ...
                while (eventType != 1) {
                    if (eventType == 2) {
                        if (StandardStructureTypes.CODE.equals(xmlPullParserNewPullParser.getName())) {
                            strNextText3 = xmlPullParserNewPullParser.nextText();
