...
public class InternalRequestOperation {
    ...
    public InternalRequestOperation(Context context, final URI uri, OSSCredentialProvider oSSCredentialProvider, ClientConfiguration clientConfiguration) {
        ...
        if (clientConfiguration != null) {
            ...
            builderHostnameVerifier.connectTimeout(connectionTimeout, timeUnit).readTimeout(clientConfiguration.getSocketTimeout(), timeUnit).writeTimeout(clientConfiguration.getSocketTimeout(), timeUnit).dispatcher(dispatcher);
