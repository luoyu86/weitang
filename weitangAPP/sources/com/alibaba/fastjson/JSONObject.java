...
public class JSONObject extends JSON implements Map<String, Object>, Cloneable, Serializable, InvocationHandler {
        ...
        if (strName == null) {
            ...
            if (name2.startsWith("get")) {
                ...
                if (!name2.startsWith("is")) {
                    if (name2.startsWith(TTDownloadField.TT_HASHCODE)) {
    ...
    public <T> T getObject(String str, Class<T> cls, Feature... featureArr) {
        ...
        return (T) TypeUtils.cast(obj, cls, ParserConfig.global, i2);
    }
    ...
    public <T> T toJavaObject(Class<T> cls, ParserConfig parserConfig, int i2) {
        return cls == Map.class ? this : (cls != Object.class || containsKey(JSON.DEFAULT_TYPE_KEY)) ? (T) TypeUtils.castToJavaBean(this, cls, parserConfig, i2) : this;
    }
