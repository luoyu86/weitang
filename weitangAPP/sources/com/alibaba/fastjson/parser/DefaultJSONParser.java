...
public class DefaultJSONParser implements Closeable {
    ...
    /* JADX WARN: Removed duplicated region for block: B:433:0x0518 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:435:0x05b1 A[SYNTHETIC] */
    ...
    */
    ...
    public String parseString() {
        ...
        if (c2 == ',') {
            ...
            if (i3 < jSONLexer2.len) {
                cCharAt = jSONLexer2.text.charAt(i3);
            }
            ...
            if (i4 < jSONLexer2.len) {
                cCharAt = jSONLexer2.text.charAt(i4);
            }
            jSONLexer2.ch = cCharAt;
            this.lexer.token = 15;
        } else if (c2 == '}') {
            ...
            if (i5 < jSONLexer2.len) {
                cCharAt = jSONLexer2.text.charAt(i5);
            }
            jSONLexer2.ch = cCharAt;
            this.lexer.token = 13;
        } else {
    ...
    public Object parse(Object obj) {
        ...
        if (i2 == 3) {
            Number numberDecimalValue = jSONLexer.decimalValue((jSONLexer.features & Feature.UseBigDecimal.mask) != 0);
            this.lexer.nextToken();
                ...
                try {
                    ...
                    if (i4 == 16) {
                        ...
                        if (Integer.TYPE != type) {
                            if (String.class == type) {
                                if (i4 == 4) {
                                    objStringVal = jSONLexer3.stringVal();
                                    this.lexer.nextToken(16);
                                } else {
                                    Object obj2 = parse();
                                    if (obj2 != null) {
            ...
            while (i5 < typeArr.length) {
                ...
                if (i6 == i4) {
                    ...
                    if (type == Integer.TYPE || type == Integer.class) {
                        if (i6 == 2) {
                            objCast = Integer.valueOf(jSONLexer3.intValue());
                            this.lexer.nextToken(16);
                        } else {
    ...
    /* JADX WARN: Removed duplicated region for block: B:60:0x00e4 A[Catch: all -> 0x0236, PHI: r5
  0x00e4: PHI (r5v4 boolean) = (r5v3 boolean), (r5v3 boolean), (r5v3 boolean), (r5v8 boolean) binds: [B:32:0x0079, B:34:0x007f, B:59:0x00e1, B:46:0x00b0] A[DONT_GENERATE, DONT_INLINE], TryCatch #0 {all -> 0x0236, blocks: (B:12:0x0028, B:15:0x003c, B:20:0x004b, B:24:0x005d, B:33:0x007b, B:35:0x0081, B:37:0x008d, B:41:0x009f, B:43:0x00a8, B:46:0x00b0, B:40:0x0099, B:48:0x00b9, B:52:0x00cb, B:54:0x00d4, B:55:0x00d7, B:51:0x00c5, B:59:0x00e1, B:60:0x00e4, B:62:0x00ea, B:83:0x0119, B:113:0x01e4, B:115:0x01eb, B:116:0x01ee, B:118:0x01f4, B:120:0x01f8, B:125:0x0208, B:128:0x0214, B:132:0x0228, B:131:0x0222, B:133:0x022b, B:85:0x0121, B:89:0x012b, B:90:0x0138, B:91:0x0140, B:92:0x0147, B:93:0x0148, B:95:0x0155, B:97:0x0165, B:96:0x0160, B:98:0x016e, B:99:0x0176, B:100:0x0180, B:101:0x018a, B:103:0x01a2, B:105:0x01ad, B:106:0x01b3, B:107:0x01b8, B:109:0x01c5, B:111:0x01d0, B:110:0x01cb, B:112:0x01d6, B:23:0x0057, B:25:0x0064, B:27:0x0069, B:30:0x0074), top: B:141:0x0028 }] */
