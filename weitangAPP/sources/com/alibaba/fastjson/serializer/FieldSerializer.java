...
public final class FieldSerializer implements Comparable<FieldSerializer> {
    ...
    public void writeValue(JSONSerializer jSONSerializer, Object obj) throws Exception {
        ...
        if ((SerializerFeature.WriteNullBooleanAsFalse.mask & i2) != 0 && Boolean.class == runtimeSerializerInfo.runtimeFieldClass) {
            jSONSerializer.out.write("false");
        } else if ((i2 & SerializerFeature.WriteNullListAsEmpty.mask) == 0 || !Collection.class.isAssignableFrom(runtimeSerializerInfo.runtimeFieldClass)) {
