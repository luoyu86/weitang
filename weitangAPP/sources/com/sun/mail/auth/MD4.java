...
public final class MD4 {
    ...
    static {
        byte[] bArr = new byte[TTDownloadField.CALL_DOWNLOAD_MODEL_SET_PACKAGE_NAME];
        padding = bArr;
        bArr[0] = -128;
    }
    ...
    private void engineUpdate(byte[] bArr, int i2, int i3) {
        if (i3 == 0) {
            return;
        }
        ...
        this.bytesProcessed += (long) i3;
        int i4 = this.bufOfs;
        if (i4 != 0) {
            int iMin = Math.min(i3, 64 - i4);
            System.arraycopy(bArr, i2, this.buffer, this.bufOfs, iMin);
            int i5 = this.bufOfs + iMin;
            this.bufOfs = i5;
            i2 += iMin;
            i3 -= iMin;
            if (i5 >= 64) {
    ...
    private void implCompress(byte[] bArr, int i2) {
        int i3 = i2;
        int i4 = 0;
        while (true) {
            int[] iArr = this.x;
            if (i4 >= iArr.length) {
                ...
                int i7 = iArr2[2];
                int i8 = iArr2[3];
                int iFF = FF(i5, i6, i7, i8, iArr[0], 3);
                int iFF2 = FF(i8, iFF, i6, i7, this.x[1], 7);
                int iFF3 = FF(i7, iFF2, iFF, i6, this.x[2], 11);
                int iFF4 = FF(i6, iFF3, iFF2, iFF, this.x[3], 19);
    ...
    private void implDigest(byte[] bArr, int i2) {
