...
public class POP3Store extends Store {
    ...
    private final synchronized boolean getBoolProp(String str) {
        ...
        String str2 = "mail." + this.name + Consts.DOT + str;
    ...
    public synchronized Protocol getPort(POP3Folder pOP3Folder) throws IOException {
        ...
        try {
            ...
            throw cleanupAndThrow(protocol2, new EOFException(e3.getMessage()));
        }
    }
    ...
    public synchronized boolean protocolConnect(String str, int i2, String str2, String str3) throws MessagingException {
        ...
        if (i2 == -1) {
            try {
                i2 = PropUtil.getIntProperty(this.session.getProperties(), "mail." + this.name + ".port", -1);
            } catch (Throwable th) {
                throw th;
            }
        }
