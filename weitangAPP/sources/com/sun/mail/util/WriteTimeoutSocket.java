...
public class WriteTimeoutSocket extends Socket {
    ...
    public WriteTimeoutSocket(Socket socket, int i2) throws IOException {
        this.socket = socket;
    ...
    public WriteTimeoutSocket(int i2) throws IOException {
        this(new Socket(), i2);
    }

    public WriteTimeoutSocket(InetAddress inetAddress, int i2, int i3) throws IOException {
        this(i3);
        this.socket.connect(new InetSocketAddress(inetAddress, i2));
    }

    public WriteTimeoutSocket(InetAddress inetAddress, int i2, InetAddress inetAddress2, int i3, int i4) throws IOException {
        this(i4);
        this.socket.bind(new InetSocketAddress(inetAddress2, i3));
        this.socket.connect(new InetSocketAddress(inetAddress, i2));
    }

    public WriteTimeoutSocket(String str, int i2, int i3) throws IOException {
        this(i3);
        this.socket.connect(new InetSocketAddress(str, i2));
    }

    public WriteTimeoutSocket(String str, int i2, InetAddress inetAddress, int i3, int i4) throws IOException {
        this(i4);
        this.socket.bind(new InetSocketAddress(inetAddress, i3));
        this.socket.connect(new InetSocketAddress(str, i2));
    }
}
