...
public class q {
    ...
    public static com.ss.android.downloadlib.addownload.a.h ok(Context context, String str, com.ss.android.downloadad.api.ok.ok okVar) {
        return p.ok(context, str, okVar);
    }

    public static com.ss.android.downloadlib.addownload.a.h ok(String str, @NonNull com.ss.android.downloadad.api.ok.ok okVar) {
        return p.a(str, okVar);
    }
