...
public class p {
    ...
    private void a(@NonNull final com.ss.android.downloadad.api.ok.a aVar, long j) {
        final int iZz = aVar.zz();
        if (com.ss.android.socialbase.downloader.h.ok.ok(iZz).a("notification_opt_2") != 1) {
            return;
        }
        ok(iZz);
        com.ss.android.downloadlib.s.ok().ok(new Runnable() { // from class: com.ss.android.downloadlib.bl.p.1
            ...
            public void run() {
                DownloadInfo downloadInfo = Downloader.getInstance(r.getContext()).getDownloadInfo(iZz);
    ...
    private void bl(@NonNull final com.ss.android.downloadad.api.ok.a aVar, long j) {
        final int iZz = aVar.zz();
        if (com.ss.android.socialbase.downloader.h.ok.ok(iZz).a("notification_opt_2") != 1) {
            return;
        }
    ...
    public void ok(@NonNull final com.ss.android.downloadad.api.ok.a aVar, long j) {
        final int iZz = aVar.zz();
        if (com.ss.android.socialbase.downloader.h.ok.ok(iZz).a("notification_opt_2") != 1) {
            return;
        }
    ...
    public void ok(int i2, com.ss.android.downloadad.api.ok.a aVar, JSONObject jSONObject) {
        ...
        if (com.ss.android.socialbase.downloader.notification.a.ok().n(i2) != null) {
            com.ss.android.socialbase.downloader.notification.a.ok().kf(i2);
        }
        com.ss.android.socialbase.appdownloader.n.ok okVar = new com.ss.android.socialbase.appdownloader.n.ok(r.getContext(), i2, downloadInfo.getTitle(), downloadInfo.getSavePath(), downloadInfo.getName(), downloadInfo.getExtra());
    ...
    public void ok(int i2) {
        ...
        if (com.ss.android.socialbase.appdownloader.n.bl.ok().ok(i2) != null || (downloadInfo = Downloader.getInstance(r.getContext()).getDownloadInfo(i2)) == null) {
            return;
        }
        com.ss.android.socialbase.appdownloader.n.bl.ok().ok(i2, downloadInfo.getIconUrl());
    }
}
