...
public class a implements z {
    ...
    public void ok(DownloadInfo downloadInfo) throws BaseException {
        PackageInfo packageInfoOk = com.ss.android.socialbase.appdownloader.bl.ok(r.getContext(), downloadInfo, downloadInfo.getSavePath(), downloadInfo.getName());
        if (packageInfoOk != null) {
            downloadInfo.setAppVersionCode(packageInfoOk.versionCode);
        }
    }
}
