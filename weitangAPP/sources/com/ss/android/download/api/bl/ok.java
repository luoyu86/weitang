...
public class ok {
    public static String a(@NonNull Uri uri) {
        ...
        return (r.q().optInt("market_scheme_opt") == 1 && n.h() && "samsungapps".equals(scheme) && pathSegments != null && pathSegments.size() == 1) ? pathSegments.get(0) : a.ok(uri.getQueryParameter("id"), uri.getQueryParameter("packagename"), uri.getQueryParameter("pkg"), uri.getQueryParameter("package_name"), uri.getQueryParameter("appId"));
    }
