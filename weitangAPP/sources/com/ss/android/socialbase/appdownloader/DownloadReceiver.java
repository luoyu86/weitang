...
public class DownloadReceiver extends BroadcastReceiver {
    ...
    private Handler f9909a = new Handler(Looper.getMainLooper());
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (action.equals("android.intent.action.BOOT_COMPLETED") && (blVarOk == null || blVarOk.ok())) {
            ...
            com.ss.android.socialbase.downloader.downloader.bl.j().execute(new Runnable() { // from class: com.ss.android.socialbase.appdownloader.DownloadReceiver.1
                ...
                public void run() {
                    ...
                    if (sVarA != null) {
                        sVarA.ok(context, schemeSpecificPart);
                    }
                    ...
                    if (successedDownloadInfosWithMimeType != null) {
                        for (final DownloadInfo downloadInfo : successedDownloadInfosWithMimeType) {
                            if (downloadInfo != null && bl.ok(downloadInfo, schemeSpecificPart)) {
                                ...
                                if (okVarN != null) {
                                    okVarN.ok((BaseException) null, false);
                                }
                                ...
                                DownloadReceiver.this.f9909a.postDelayed(new Runnable() { // from class: com.ss.android.socialbase.appdownloader.DownloadReceiver.1.1
                                    @Override // java.lang.Runnable
                                    public void run() {
