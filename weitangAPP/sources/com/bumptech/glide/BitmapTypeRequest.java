...
public class BitmapTypeRequest<ModelType> extends BitmapRequestBuilder<ModelType, Bitmap> {
    ...
    public BitmapRequestBuilder<ModelType, byte[]> toBytes(Bitmap.CompressFormat compressFormat, int i2) {
        return (BitmapRequestBuilder<ModelType, byte[]>) transcode(new BitmapBytesTranscoder(compressFormat, i2), byte[].class);
    }
}
