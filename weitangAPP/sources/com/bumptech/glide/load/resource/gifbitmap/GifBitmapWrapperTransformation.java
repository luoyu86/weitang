...
public class GifBitmapWrapperTransformation implements Transformation<GifBitmapWrapper> {
    ...
    @Override // com.bumptech.glide.load.Transformation
    public Resource<GifBitmapWrapper> transform(Resource<GifBitmapWrapper> resource, int i2, int i3) {
        ...
        if (bitmapResource != null && (transformation2 = this.bitmapTransformation) != null) {
            Resource<Bitmap> resourceTransform = transformation2.transform(bitmapResource, i2, i3);
        ...
        Resource<GifDrawable> resourceTransform2 = transformation.transform(gifResource, i2, i3);
