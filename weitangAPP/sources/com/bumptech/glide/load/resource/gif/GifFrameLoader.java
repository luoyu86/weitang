...
public class GifFrameLoader {
    ...
    public GifFrameLoader(Context context, FrameCallback frameCallback, GifDecoder gifDecoder, int i2, int i3) {
        this(frameCallback, gifDecoder, null, getRequestBuilder(context, gifDecoder, i2, i3, Glide.get(context).getBitmapPool()));
    }

    private static GenericRequestBuilder<GifDecoder, GifDecoder, Bitmap, Bitmap> getRequestBuilder(Context context, GifDecoder gifDecoder, int i2, int i3, BitmapPool bitmapPool) {
