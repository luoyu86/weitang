...
public class GifResourceDecoder implements ResourceDecoder<InputStream, GifDrawable> {
    ...
    @Override // com.bumptech.glide.load.ResourceDecoder
    public GifDrawableResource decode(InputStream inputStream, int i2, int i3) {
        ...
        try {
            return decode(bArrInputStreamToBytes, i2, i3, gifHeaderParserObtain, gifDecoderObtain);
        } finally {
    ...
    private GifDrawableResource decode(byte[] bArr, int i2, int i3, GifHeaderParser gifHeaderParser, GifDecoder gifDecoder) {
        ...
        return new GifDrawableResource(new GifDrawable(this.context, this.provider, this.bitmapPool, UnitTransformation.get(), i2, i3, header, bArr, bitmapDecodeFirstFrame));
    }
}
