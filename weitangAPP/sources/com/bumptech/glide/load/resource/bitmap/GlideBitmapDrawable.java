...
public class GlideBitmapDrawable extends GlideDrawable {
    ...
    public GlideBitmapDrawable(Resources resources, BitmapState bitmapState) {
        ...
        if (resources != null) {
            ...
            i2 = i2 == 0 ? 160 : i2;
            bitmapState.targetDensity = i2;
        } else {
            i2 = bitmapState.targetDensity;
        }
        this.width = bitmapState.bitmap.getScaledWidth(i2);
        this.height = bitmapState.bitmap.getScaledHeight(i2);
    }
}
