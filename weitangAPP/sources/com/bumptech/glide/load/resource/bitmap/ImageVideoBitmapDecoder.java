...
public class ImageVideoBitmapDecoder implements ResourceDecoder<ImageVideoWrapper, Bitmap> {
    ...
    @Override // com.bumptech.glide.load.ResourceDecoder
    public Resource<Bitmap> decode(ImageVideoWrapper imageVideoWrapper, int i2, int i3) throws IOException {
        Resource<Bitmap> resourceDecode;
        ParcelFileDescriptor fileDescriptor;
        InputStream stream = imageVideoWrapper.getStream();
        if (stream != null) {
            try {
                resourceDecode = this.streamDecoder.decode(stream, i2, i3);
        ...
        return (resourceDecode != null || (fileDescriptor = imageVideoWrapper.getFileDescriptor()) == null) ? resourceDecode : this.fileDescriptorDecoder.decode(fileDescriptor, i2, i3);
    }
}
