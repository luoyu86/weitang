...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    private Request buildRequestRecursive(Target<TranscodeType> target, ThumbnailRequestCoordinator thumbnailRequestCoordinator) {
        ...
        Request requestObtainRequest = obtainRequest(target, this.sizeMultiplier.floatValue(), this.priority, thumbnailRequestCoordinator3);
        this.isThumbnailBuilt = true;
        Request requestBuildRequestRecursive = this.thumbnailRequestBuilder.buildRequestRecursive(target, thumbnailRequestCoordinator3);
        this.isThumbnailBuilt = false;
        thumbnailRequestCoordinator3.setRequests(requestObtainRequest, requestBuildRequestRecursive);
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> animate(int i2) {
        return animate(new ViewAnimationFactory(this.context, i2));
    }
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> error(int i2) {
        this.errorId = i2;
        return this;
    }
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> override(int i2, int i3) {
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> placeholder(int i2) {
        this.placeholderId = i2;
        return this;
    }

    public Target<TranscodeType> preload(int i2, int i3) {
        return into(PreloadTarget.obtain(i2, i3));
    }
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> mo67clone() {
        try {
            ...
            ChildLoadProvider<ModelType, DataType, ResourceType, TranscodeType> childLoadProvider = this.loadProvider;
            genericRequestBuilder.loadProvider = childLoadProvider != null ? childLoadProvider.m68clone() : null;
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> fallback(int i2) {
    ...
    public Target<TranscodeType> into(ImageView imageView) {
        ...
        if (imageView != null) {
            if (!this.isTransformationSet && imageView.getScaleType() != null) {
                int i2 = AnonymousClass2.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
                if (i2 == 1) {
                    applyCenterCrop();
    ...
    public FutureTarget<TranscodeType> into(int i2, int i3) {
        final RequestFutureTarget requestFutureTarget = new RequestFutureTarget(this.glide.getMainHandler(), i2, i3);
