...
public class GifRequestBuilder<ModelType> extends GenericRequestBuilder<ModelType, InputStream, GifDrawable, GifDrawable> implements BitmapOptions, DrawableOptions {
    ...
    private GifDrawableTransformation[] toGifTransformations(Transformation<Bitmap>[] transformationArr) {
        ...
        for (int i2 = 0; i2 < transformationArr.length; i2++) {
            gifDrawableTransformationArr[i2] = new GifDrawableTransformation(transformationArr[i2], this.glide.getBitmapPool());
        }
    ...
    @Override // com.bumptech.glide.GenericRequestBuilder
    public GifRequestBuilder<ModelType> override(int i2, int i3) {
    ...
    public GifRequestBuilder<ModelType> mo67clone() {
        return (GifRequestBuilder) super.mo67clone();
    }

    @Override // com.bumptech.glide.GenericRequestBuilder
    public GifRequestBuilder<ModelType> error(int i2) {
        super.error(i2);
        return this;
    }
    ...
    @Override // com.bumptech.glide.GenericRequestBuilder
    public GifRequestBuilder<ModelType> placeholder(int i2) {
    ...
    @Override // com.bumptech.glide.GenericRequestBuilder
    public GifRequestBuilder<ModelType> animate(int i2) {
        super.animate(i2);
        return this;
    }
    ...
    @Override // com.bumptech.glide.GenericRequestBuilder
    public GifRequestBuilder<ModelType> fallback(int i2) {
        super.fallback(i2);
        return this;
    }
    ...
    @Override // com.bumptech.glide.DrawableOptions
    public GifRequestBuilder<ModelType> crossFade(int i2) {
    ...
    @Override // com.bumptech.glide.DrawableOptions
    @Deprecated
    public GifRequestBuilder<ModelType> crossFade(Animation animation, int i2) {
        super.animate(new DrawableCrossFadeFactory(animation, i2));
        return this;
    }

    @Override // com.bumptech.glide.DrawableOptions
    public GifRequestBuilder<ModelType> crossFade(int i2, int i3) {
