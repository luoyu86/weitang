...
public final class GeneralAppIdDecoder {
    ...
    private DecodedChar decodeIsoIec646(int i2) {
        ...
        int iExtractNumericValueFromBitArray3 = extractNumericValueFromBitArray(i2, 8);
        switch (iExtractNumericValueFromBitArray3) {
            case 232:
                c2 = '!';
                break;
            case SubmitLifeOrderVo.ITEM_TYPE_INFO /* 233 */:
                c2 = '\"';
                break;
            case 234:
                c2 = '%';
            ...
            case 244:
                c2 = '/';
                break;
            case SubmitLifeOrderVo.ITEM_TYPE_EDT /* 245 */:
                c2 = ':';
                break;
            case 246:
                c2 = ';';
            ...
            case 252:
                ...
                break;
            default:
                throw new IllegalArgumentException("Decoding invalid ISO/IEC 646 value: " + iExtractNumericValueFromBitArray3);
        }
