...
public abstract class AI01decoder extends AbstractExpandedDecoder {
    ...
    public void encodeCompressedGtinWithoutAI(StringBuilder sb, int i2, int i3) {
        for (int i4 = 0; i4 < 4; i4++) {
            int iExtractNumericValueFromBitArray = getGeneralDecoder().extractNumericValueFromBitArray((i4 * 10) + i2, 10);
