...
public final class GenericMultipleBarcodeReader implements MultipleBarcodeReader {
    ...
    private void doDecodeMultiple(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map, List<Result> list, int i2, int i3) {
        boolean z;
        float f2;
        float f3;
        try {
            ...
            if (f4 > 100.0f) {
                f2 = f5;
                f3 = f7;
                doDecodeMultiple(binaryBitmap.crop(0, 0, (int) f4, height), map, list, i2, i3);
            } else {
                f2 = f5;
                f3 = f7;
            }
            if (f6 > 100.0f) {
                doDecodeMultiple(binaryBitmap.crop(0, 0, width, (int) f6), map, list, i2, i3);
            }
            float f8 = f3;
            if (f8 < width - 100) {
                int i4 = (int) f8;
                doDecodeMultiple(binaryBitmap.crop(i4, 0, width - i4, height), map, list, i2 + i4, i3);
            }
            float f9 = f2;
            if (f9 < height - 100) {
                int i5 = (int) f9;
                doDecodeMultiple(binaryBitmap.crop(0, i5, width, height - i5), map, list, i2, i3 + i5);
            }
