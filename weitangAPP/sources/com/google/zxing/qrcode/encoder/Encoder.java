...
public final class Encoder {
    ...
    public static void appendLengthInfo(int i2, int i3, Mode mode, BitArray bitArray) throws WriterException {
        int characterCountBits = mode.getCharacterCountBits(Version.getVersionForNumber(i3));
        int i4 = (1 << characterCountBits) - 1;
        if (i2 <= i4) {
    ...
    private static int chooseMaskPattern(BitArray bitArray, ErrorCorrectionLevel errorCorrectionLevel, int i2, ByteMatrix byteMatrix) throws WriterException {
        ...
        for (int i5 = 0; i5 < 8; i5++) {
            MatrixUtil.buildMatrix(bitArray, errorCorrectionLevel, i2, i5, byteMatrix);
            int iCalculateMaskPenalty = calculateMaskPenalty(byteMatrix);
            if (iCalculateMaskPenalty < i3) {
                i4 = i5;
                i3 = iCalculateMaskPenalty;
            }
        }
        return i4;
    }
    ...
    private static void initQRCode(int i2, ErrorCorrectionLevel errorCorrectionLevel, Mode mode, QRCode qRCode) throws WriterException {
        ...
        for (int i3 = 1; i3 <= 40; i3++) {
            ...
            int i4 = totalCodewords - totalECCodewords;
            if (i4 >= getTotalInputBytes(i2, versionForNumber, mode)) {
                qRCode.setVersion(i3);
                qRCode.setNumTotalBytes(totalCodewords);
                qRCode.setNumDataBytes(i4);
    ...
    public static void interleaveWithECBytes(BitArray bitArray, int i2, int i3, int i4, BitArray bitArray2) throws WriterException {
    ...
    public static void encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map, QRCode qRCode) throws WriterException {
        ...
        initQRCode(bitArray.getSize(), errorCorrectionLevel, modeChooseMode, qRCode);
        ...
        appendLengthInfo(modeChooseMode == mode ? bitArray.getSizeInBytes() : str.length(), qRCode.getVersion(), modeChooseMode, bitArray2);
