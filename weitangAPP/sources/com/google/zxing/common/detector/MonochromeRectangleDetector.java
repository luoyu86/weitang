...
public final class MonochromeRectangleDetector {
    ...
    */
    ...
    public ResultPoint[] detect() throws NotFoundException {
        ...
        int i6 = i2 >> 1;
        ResultPoint resultPointFindCornerFromCenter = findCornerFromCenter(i3, -iMax2, 0, width, i2, 0, y, height, i6);
        int x = ((int) resultPointFindCornerFromCenter.getX()) - 1;
        ResultPoint resultPointFindCornerFromCenter2 = findCornerFromCenter(i3, iMax2, x, width, i2, 0, y, height, i6);
        int x2 = ((int) resultPointFindCornerFromCenter2.getX()) + 1;
        ResultPoint resultPointFindCornerFromCenter3 = findCornerFromCenter(i3, 0, x, x2, i2, iMax, y, height, i5);
        return new ResultPoint[]{findCornerFromCenter(i3, 0, x, x2, i2, i4, y, ((int) resultPointFindCornerFromCenter3.getY()) + 1, i3 >> 2), resultPointFindCornerFromCenter, resultPointFindCornerFromCenter2, resultPointFindCornerFromCenter3};
    }
}
