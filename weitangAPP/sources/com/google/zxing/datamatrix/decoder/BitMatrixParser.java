...
public final class BitMatrixParser {
    ...
    public int readCorner1(int i2, int i3) {
        int i4 = i2 - 1;
    ...
    public int readCorner2(int i2, int i3) {
    ...
    public int readCorner3(int i2, int i3) {
        int i4 = i2 - 1;
        int i5 = (readModule(i4, 0, i2, i3) ? 1 : 0) << 1;
        int i6 = i3 - 1;
    ...
    public int readCorner4(int i2, int i3) {
        int i4 = (readModule(i2 + (-3), 0, i2, i3) ? 1 : 0) << 1;
        if (readModule(i2 - 2, 0, i2, i3)) {
            i4 |= 1;
        }
    ...
    public boolean readModule(int i2, int i3, int i4, int i5) {
        if (i2 < 0) {
            i2 += i4;
            i3 += 4 - ((i4 + 4) & 7);
        }
    ...
    public int readUtah(int i2, int i3, int i4, int i5) {
        int i6 = i2 - 2;
        int i7 = i3 - 2;
