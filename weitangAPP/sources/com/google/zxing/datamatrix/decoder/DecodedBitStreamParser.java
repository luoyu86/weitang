...
public final class DecodedBitStreamParser {
    ...
    private static final char[] C40_SHIFT2_SET_CHARS = {'!', '\"', '#', DecodedChar.FNC1, '%', '&', '\'', '(', ')', '*', '+', ',', Soundex.SILENT_MARKER, '.', '/', ':', ';', '<', a.f5521h, '>', RFC1522Codec.SEP, '@', '[', '\\', ']', '^', '_'};
    ...
    private static int unrandomize255State(int i2, int i3) {
        int i4 = i2 - (((i3 * TTDownloadField.CALL_DOWNLOAD_MODEL_SET_VERSION_CODE) % 255) + 1);
