...
public class TabLayout extends HorizontalScrollView {
            ...
            if (i4 >= 0 && this.indicatorRight > i4) {
                ...
                if (paint != null) {
                    if (Build.VERSION.SDK_INT == 21) {
                        drawableWrap.setColorFilter(paint.getColor(), PorterDuff.Mode.SRC_IN);
                    } else {
    ...
    */
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, iArr, i2, i3, i4);
        ...
        this.tabPaddingStart = typedArrayObtainStyledAttributes.getDimensionPixelSize(com.google.android.material.R.styleable.TabLayout_tabPaddingStart, dimensionPixelSize);
        ...
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(i4, com.google.android.material.R.style.TextAppearance_Design_Tab);
        ...
        try {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(i5)) {
                this.tabTextColors = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, i5);
            }
            ...
            this.tabIconTint = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, com.google.android.material.R.styleable.TabLayout_tabIconTint);
            this.tabIconTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(com.google.android.material.R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, com.google.android.material.R.styleable.TabLayout_tabRippleColor);
