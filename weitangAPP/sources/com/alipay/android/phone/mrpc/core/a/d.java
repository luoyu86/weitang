...
public final class d extends a {
    ...
    public final Object a() {
        try {
            String str = new String(this.f5057b);
            StringBuilder sb = new StringBuilder("threadid = ");
            sb.append(Thread.currentThread().getId());
            sb.append("; rpc response:  ");
            sb.append(str);
            JSONObject jSONObject = new JSONObject(str);
            int i2 = jSONObject.getInt(l.f5707a);
            if (i2 == 1000) {
                return this.f5056a == String.class ? jSONObject.optString("result") : com.alipay.sdk.m.e.e.a(jSONObject.optString("result"), this.f5056a);
            }
            throw new RpcException(Integer.valueOf(i2), jSONObject.optString("tips"));
        } catch (Exception e2) {
            StringBuilder sb2 = new StringBuilder("response  =");
            sb2.append(new String(this.f5057b));
            sb2.append(":");
            sb2.append(e2);
