...
public final class b {
                ...
                if (sensorManager != null && (sensorList = sensorManager.getSensorList(-1)) != null && sensorList.size() > 0) {
                    for (Sensor sensor : sensorList) {
                        if (sensor != null) {
                            ...
                            jSONObject.put(IMAPStore.ID_VENDOR, sensor.getVendor());
    ...
    */
    ...
    private String v() {
        ...
        if (this.f5260a.isBackgroundRunning()) {
            return "";
        }
        try {
    ...
    public final synchronized String a(Context context) {
        String subscriberId = this.f5260a.getSubscriberId();
        if (subscriberId != null) {
            return subscriberId;
        }
        String strA = d.a(Constants.KEY_IMSI);
        if (strA != null) {
            return strA;
        }
        if (this.f5260a.isBackgroundRunning()) {
    ...
    */
    public final synchronized java.lang.String c(android.content.Context r3) {
        /*
            ...
            java.lang.String r0 = com.alipay.sdk.m.a0.d.a(r0)     // Catch: java.lang.Throwable -> L40
            if (r0 == 0) goto Lb
            monitor-exit(r2)
            return r0
        Lb:
            com.alipay.sdk.m.a0.f r1 = r2.f5260a     // Catch: java.lang.Throwable -> L40
        ...
        L17:
            ...
            boolean r1 = a(r3, r1)     // Catch: java.lang.Throwable -> L40
            if (r1 == 0) goto L23
            java.lang.String r3 = ""
            monitor-exit(r2)
            return r3
        ...
        L39:
            ...
            com.alipay.sdk.m.a0.d.a(r3, r0)     // Catch: java.lang.Throwable -> L40
            monitor-exit(r2)
            return r0
        L40:
            r3 = move-exception
    ...
    public final synchronized String d(Context context) {
        String androidId = this.f5260a.getAndroidId();
        if (androidId != null) {
            return androidId;
        }
