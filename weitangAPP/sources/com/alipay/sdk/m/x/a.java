...
public class a {
    ...
    public static final String f5745i = "正在加载";
    ...
    public final int f5750e = 1;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public final long f5751f = 10000;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public boolean f5752g = false;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public Handler f5753h = new c(Looper.getMainLooper());
    ...
    public class RunnableC0093a implements Runnable {
        ...
        public void run() {
            if (a.this.f5746a == null) {
                a aVar = a.this;
                a aVar2 = a.this;
                aVar.f5746a = aVar2.new d(aVar2.f5747b);
                a.this.f5746a.setCancelable(a.this.f5752g);
            }
            try {
                if (a.this.f5746a.isShowing()) {
                    return;
                }
                a.this.f5746a.show();
                a.this.f5753h.sendEmptyMessageDelayed(1, 10000L);
            } catch (Exception e2) {
    ...
    public class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (a.this.f5746a == null || !a.this.f5746a.isShowing()) {
                return;
            }
            try {
                a.this.f5753h.removeMessages(1);
    ...
    public class d extends AlertDialog {
        ...
        private View a(Context context) {
            ...
            layoutParams2.setMargins(a(a.this.f5747b, 17.0f), a(a.this.f5747b, 10.0f), a(a.this.f5747b, 8.0f), a(a.this.f5747b, 10.0f));
            ...
            textView.setText(TextUtils.isEmpty(a.this.f5748c) ? a.f5745i : a.this.f5748c);
