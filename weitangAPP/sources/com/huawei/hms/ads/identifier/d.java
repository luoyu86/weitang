...
public abstract class d {
    ...
    private static final byte[] f9105a = new byte[0];

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final byte[] f9106b = new byte[0];

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static SoftReference<byte[]> f9107c;

    public static class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final Long f9110a = 120000L;

        /* JADX INFO: renamed from: h, reason: collision with root package name */
        private static final byte[] f9111h = new byte[0];

        /* JADX INFO: renamed from: i, reason: collision with root package name */
        private static volatile a f9112i;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private SharedPreferences f9113b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private SharedPreferences f9114c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        private SharedPreferences f9115d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        private final byte[] f9116e = new byte[0];

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        private final byte[] f9117f = new byte[0];

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        private final byte[] f9118g = new byte[0];
        private Context j;
        ...
        private a(Context context) {
            ...
            try {
                ...
                this.f9113b = contextA.getSharedPreferences("identifier_sp_story_book_file", 4);
                this.f9114c = contextA.getSharedPreferences("identifier_hiad_sp_bed_rock_file", 4);
                this.f9115d = contextA.getSharedPreferences("identifier_hiad_sp_red_stone_file", 4);
            } catch (Throwable th) {
        ...
        public void a(String str) {
            synchronized (this.f9117f) {
                ...
                this.f9115d.edit().putString("read_first_chapter", d.b(str, bArrA)).apply();
            }
        }

        public void b() {
            synchronized (this.f9118g) {
                SharedPreferences sharedPreferences = this.f9113b;
                if (sharedPreferences == null) {
                    return;
                }
        ...
        public void b(String str) {
            synchronized (this.f9116e) {
                SharedPreferences sharedPreferences = this.f9114c;
                if (sharedPreferences == null) {
                    return;
                }
        ...
        public boolean c() {
            synchronized (this.f9118g) {
                ...
                return j + f9110a.longValue() > System.currentTimeMillis();
            }
        }
        ...
        public void d(String str) {
            synchronized (this.f9118g) {
                this.f9113b.edit().putString("read_second_chapter", str).apply();
            }
        }
        ...
        public String h() {
            String string;
            synchronized (this.f9118g) {
                string = this.f9113b.getString("read_second_chapter", "");
            }
            return string;
        }
    }
    ...
    public static byte[] a(Context context) {
        ...
        byte[] bArrC;
        synchronized (f9106b) {
            SoftReference<byte[]> softReference = f9107c;
    ...
    private static String f(Context context) {
        ...
        e.f9119a.execute(new Runnable() { // from class: com.huawei.hms.ads.identifier.d.1
