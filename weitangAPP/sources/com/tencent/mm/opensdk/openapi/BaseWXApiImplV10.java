...
public class BaseWXApiImplV10 implements IWXAPI {
    ...
    private void launchWXUsingPendingIntent() {
        ...
        try {
            ...
            if (i2 < 35) {
                activity = PendingIntent.getActivity(this.context, 1, launchIntentForPackage, i3);
            } else {
                ...
                activity = PendingIntent.getActivity(this.context, 1, launchIntentForPackage, i3, activityOptionsMakeBasic.toBundle());
            }
            activity.send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.3
                ...
                public void onSendFinished(PendingIntent pendingIntent, Intent intent, int i4, String str, Bundle bundle) {
                    Log.d(BaseWXApiImplV10.TAG, "onSendFinished resultCode: " + i4 + ", resultData: " + str);
                }
            }, null);
        } catch (Exception e2) {
    ...
    private boolean sendLaunchWXMiniprogram(Context context, BaseReq baseReq) {
        ...
        Cursor cursorQuery = contentResolver.query(uri, null, null, new String[]{this.appId, req.userName, req.path, sb.toString(), req.extData}, null);
        if (cursorQuery != null) {
            cursorQuery.close();
        }
        return true;
    ...
    private boolean sendOpenBusinessWebview(Context context, BaseReq baseReq) {
        ...
        Cursor cursorQuery = contentResolver.query(uri, null, null, new String[]{this.appId, sb.toString(), string}, null);
        if (cursorQuery != null) {
            cursorQuery.close();
        }
        return true;
    ...
    private boolean sendPayInSurance(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Cursor cursorQuery = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview"), null, null, new String[]{this.appId, MessageService.MSG_ACCS_READY_REPORT, URLEncoder.encode(String.format("url=%s", URLEncoder.encode(((WXPayInsurance.Req) baseReq).url)))}, null);
        if (cursorQuery != null) {
            cursorQuery.close();
        }
        return true;
    ...
    private boolean sendPayReq(Context context, Bundle bundle) {
        ...
        try {
            ...
            Log.e(TAG, "getTokenFromWX fail, exception = ".concat(String.valueOf(e3)));
        }
            ...
            d.b().submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
                ...
                public void run() {
                    try {
                        ...
                        Log.w(BaseWXApiImplV10.TAG, e3.getMessage());
                    }
    ...
    public boolean isWXAppInstalled() {
        ...
        try {
            ...
            Log.w(TAG, "isWXAppInstalled ex:" + e2.getMessage());
            return false;
        }
    }
    ...
    public boolean registerApp(String str, long j) {
        ...
        c0179a.f10524a = "com.tencent.mm";
        c0179a.action = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0179a.content = "weixin://registerapp?appid=" + this.appId;
        c0179a.f10525b = j;
        return a.a(this.context, c0179a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0179a c0179a = new a.C0179a();
        c0179a.f10524a = "com.tencent.mm";
        c0179a.action = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0179a.content = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0179a);
    }
}
