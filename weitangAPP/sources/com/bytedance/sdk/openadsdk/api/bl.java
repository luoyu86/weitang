...
public class bl {
    ...
    private static int f6320a = 4;
    private static boolean ok = false;

    public static void a(String str, String str2) {
        if (ok && str2 != null && f6320a <= 3) {
            Log.d(str, str2);
        }
    }

    public static void bl(String str, String str2) {
        if (ok && str2 != null && f6320a <= 4) {
            Log.i(str, str2);
        }
    }

    public static void n(String str, String str2) {
        if (ok && str2 != null && f6320a <= 6) {
            Log.e(str, str2);
        }
    }
    ...
    public static void ok(String str, String str2) {
        if (ok && str2 != null && f6320a <= 2) {
            Log.v(str, str2);
        }
    }

    public static void a(String str, Object... objArr) {
        if (ok && objArr != null && f6320a <= 5) {
            Log.v(str, ok(objArr));
        }
    }
