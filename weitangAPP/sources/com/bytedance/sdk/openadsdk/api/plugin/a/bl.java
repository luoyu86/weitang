...
public class bl {
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(10:0|2|48|3|4|(5:41|5|(1:11)(1:10)|12|(4:16|45|17|18))|43|19|30|(1:(0))) */
    /* JADX WARN: Removed duplicated region for block: B:39:0x008d A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public java.lang.String ok(boolean r4, java.lang.String r5, byte[] r6) throws java.lang.Throwable {
        /*
            r3 = this;
            r0 = 0
    ...
    private static byte[] ok(InputStream inputStream, int i2) throws IOException {
        if (inputStream == null) {
            return null;
        }
        if (i2 < 1) {
    ...
    private static String ok(String str, String str2) {
        if (str != null) {
            String[] strArrSplit = str.split(i.f5697b, 0);
