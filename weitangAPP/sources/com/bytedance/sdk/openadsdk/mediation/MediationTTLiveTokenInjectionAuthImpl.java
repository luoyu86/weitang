...
public class MediationTTLiveTokenInjectionAuthImpl implements Bridge, ITTLiveTokenInjectionAuth {
    ...
    public <T> T call(int i2, ValueSet valueSet, Class<T> cls) {
        ...
        if (i2 != 8519) {
            if (i2 != 8525 || (valueSet2 = (ValueSet) valueSet.objectValue(8526, ValueSet.class)) == null) {
                return null;
            }
        ...
        mediationValueSetBuilderCreate.add(8520, tokenInfo.name);
        mediationValueSetBuilderCreate.add(8521, tokenInfo.accessToken);
        mediationValueSetBuilderCreate.add(8522, tokenInfo.openId);
        mediationValueSetBuilderCreate.add(8523, tokenInfo.expireAt);
        mediationValueSetBuilderCreate.add(8524, tokenInfo.refreshToken);
        return (T) mediationValueSetBuilderCreate.build();
    }
