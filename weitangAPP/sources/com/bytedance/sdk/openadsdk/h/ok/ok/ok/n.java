...
public class n implements Bridge {
    ...
    public <T> T call(int i2, ValueSet valueSet, Class<T> cls) {
        ...
        switch (i2) {
            case 153101:
                this.f6379a.onError(valueSet.intValue(0), (String) valueSet.objectValue(1, String.class));
                break;
            case 153102:
                ...
                while (it.hasNext()) {
                    arrayList2.add(new t((Bridge) it.next()));
                }
                this.f6379a.onNativeExpressAdLoad(arrayList2);
                break;
        }
        ok(i2, valueSet, cls);
        return null;
