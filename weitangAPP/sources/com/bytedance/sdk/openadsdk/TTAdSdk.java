...
public final class TTAdSdk {
    ...
    private static TTAdConfig f6314a;
    ...
    public static void getCodeGroupRit(final long j, final TTCodeGroupRit.TTCodeGroupRitListener tTCodeGroupRitListener) {
        ...
        if (okVar != null) {
            ...
            tTCodeGroupRitListener.onFail(SpdyAgent.SPDY_STREAM_CLOSE, "please init sdk first!");
        }
    }
    ...
    public static void start(Callback callback) {
        ok(f6314a, "TTAdConfig is null, please exec TTAdSdk.init before TTAdSdk.start.");
        ok okVar = ok;
        if (okVar == null) {
            callback.fail(SpdyAgent.SPDY_STREAM_CLOSE, "Load initializer failed");
        } else {
            okVar.ok(TTAppContextHolder.getContext(), f6314a, callback);
        }
    }

    public static void updateAdConfig(TTAdConfig tTAdConfig) {
        ok.bl blVarA;
        if (tTAdConfig == null || (blVarA = ok.a()) == null) {
            return;
        }
        ...
        blVarA.getExtra(ValueSet.class, bundle);
    }
