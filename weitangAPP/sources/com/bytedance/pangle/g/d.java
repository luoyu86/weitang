            ...
            try {
                try {
                    ...
                    try {
                        try {
                            try {
                                m mVar = f.f6079a.get(str).get(-262969152);
                                if (mVar == null) {
                                    throw new n("findVerifiedSigner, No APK Signature Scheme v3 signature in package");
                                }
                                c.C0104c c0104cA = c.a(randomAccessFile, mVar);
                                Signature[] signatureArrA = a(new Certificate[][]{c0104cA.f6076a});
                                c.b bVar = c0104cA.f6077b;
                                if (bVar != null) {
                                    int size = bVar.f6074a.size();
                                    Signature[] signatureArr2 = new Signature[size];
                                    iArr = new int[c0104cA.f6077b.f6075b.size()];
                                    for (int i2 = 0; i2 < size; i2++) {
                                        signatureArr2[i2] = new Signature(c0104cA.f6077b.f6074a.get(i2).getEncoded());
                                        iArr[i2] = c0104cA.f6077b.f6075b.get(i2).intValue();
                                    }
                                ...
                                m mVar2 = f.f6079a.get(str).get(1896449818);
                                if (mVar2 == null) {
                                    throw new n("findVerifiedSigner, No APK Signature Scheme v2 signature in package");
                                }
                                o oVar2 = new o(a(b.a(randomAccessFile, mVar2).f6072a));
                                try {
                                    randomAccessFile.close();
