...
public class ZeusTransformUtils {
    ...
    public static int getIdentifier(Object obj, String str, String str2, String str3, String str4) {
        ...
        if (!TextUtils.equals(DispatchConstants.ANDROID, str3)) {
            str3 = str4;
        }
    ...
    private static void handleAttrAfter(TypedArray typedArray, int[] iArr, int[] iArr2) {
        ...
        for (int i2 = 0; i2 < iArr.length; i2++) {
            map.put(Integer.valueOf(iArr[i2]), Integer.valueOf(i2));
        }
        HashMap map2 = new HashMap();
        for (int i3 = 0; i3 < iArr2.length; i3++) {
            map2.put((Integer) map.get(Integer.valueOf(iArr2[i3])), Integer.valueOf(i3));
        }
        try {
    ...
    public static View inflate(LayoutInflater layoutInflater, int i2, ViewGroup viewGroup, boolean z, String str) {
        ...
        View viewInflate = layoutInflater.inflate(i2, viewGroup, z);
        clearConstructorCache();
        return viewInflate;
    }
    ...
    public static int mapRes(int i2, String str, String str2) {
        ...
        if (identifier == 0) {
            identifier = Zeus.getAppApplication().getResources().getIdentifier(str2.replace("_", Consts.DOT), str, Zeus.getAppApplication().getPackageName());
        }
        if (identifier == 0) {
    ...
    public static TypedArray obtainStyledAttributes(Object obj, AttributeSet attributeSet, int[] iArr, int i2, int i3, String str) {
        ...
        if (obj instanceof Resources.Theme) {
            ...
            TypedArray typedArrayObtainStyledAttributes2 = ((Resources.Theme) obj).obtainStyledAttributes(attributeSet, iArrHandleAttrBefore2, i2, i3);
    ...
    public static TypedArray obtainStyledAttributes(Object obj, int i2, int[] iArr, String str) {
        if (obj instanceof Context) {
            int[] iArrHandleAttrBefore = handleAttrBefore(iArr);
            TypedArray typedArrayObtainStyledAttributes = ((Context) obj).obtainStyledAttributes(i2, iArrHandleAttrBefore);
            handleAttrAfter(typedArrayObtainStyledAttributes, iArrHandleAttrBefore, iArr);
            return typedArrayObtainStyledAttributes;
        }
        if (obj instanceof Resources.Theme) {
            int[] iArrHandleAttrBefore2 = handleAttrBefore(iArr);
            TypedArray typedArrayObtainStyledAttributes2 = ((Resources.Theme) obj).obtainStyledAttributes(i2, iArrHandleAttrBefore2);
            handleAttrAfter(typedArrayObtainStyledAttributes2, iArrHandleAttrBefore2, iArr);
            return typedArrayObtainStyledAttributes2;
        }
        try {
