...
public class ContentProviderManager {
    ...
    public static final class a {
        ...
        public final ProviderInfo f6175b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        public final PluginContentProvider f6176c;

        public a(b bVar, ProviderInfo providerInfo, PluginContentProvider pluginContentProvider) {
            this.f6175b = providerInfo;
            this.f6174a = bVar;
            this.f6176c = pluginContentProvider;
        }
    }
    ...
    public static class b {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof b) {
                b bVar = (b) obj;
                if (TextUtils.equals(this.f6179c, bVar.f6179c) && TextUtils.equals(this.f6178b, bVar.f6178b) && TextUtils.equals(this.f6177a, bVar.f6177a)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            ...
            return (this.f6177a + this.f6178b + this.f6177a).hashCode();
        }
    }
