...
public class IntentUtils {
    ...
    public static HashMap<Long, WeakReference<Bundle>> f5943a = new HashMap<>();
    ...
    public static void a(Intent intent, String str) {
        ...
        if (longExtra != 0) {
            ...
            f5943a.put(Long.valueOf(longExtra), new WeakReference<>(extras));
    ...
    public static void a(Intent intent) {
        long longExtra = intent.getLongExtra("pangle_use_memory", 0L);
        if (longExtra != 0) {
            WeakReference<Bundle> weakReferenceRemove = f5943a.remove(Long.valueOf(longExtra));
