        ...
        try {
            ...
            a(file, (HashSet<String>) hashSet, new h() { // from class: com.bytedance.pangle.res.a.c.1
                ...
                public final int a(int i3) {
                    ...
                    if (identifier == 0) {
                        identifier = Zeus.getAppApplication().getResources().getIdentifier(str2.split(" ")[1].replaceAll("_", Consts.DOT), str2.split(" ")[0], Zeus.getAppApplication().getPackageName());
                    }
                    if (identifier == 0) {
        ...
        if (i2 != -1) {
            ...
            while (i6 < i7) {
                if (mappedByteBufferA.getInt(i6) == 33639248) {
                    ...
                    short s = mappedByteBufferA.getShort(i6 + 30);
                    ...
                    if (hashSet.contains(str)) {
                        if (i10 == i11) {
                            ...
                            try {
                                ...
                                for (int i12 = 0; i12 < eVarA.f6283b.length; i12++) {
                                    mappedByteBufferA.put(eVarA.f6282a.intValue() + i12, eVarA.f6283b[i12]);
                                }
                            } catch (Throwable th) {
