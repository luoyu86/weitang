    ...
    public static void postStateChange(@Nullable final String str, final int i2, final Object... objArr) {
        mHandler.post(new Runnable() { // from class: com.bytedance.pangle.ZeusPluginStateListener.1
            ...
            public final void run() {
                ...
                while (it.hasNext()) {
                    it.next().onPluginStateChange(TextUtils.isEmpty(str) ? POP3Message.UNKNOWN : str, i2, objArr);
                }
            }
        });
        List<ZeusPluginStateListener> list = i.a().f6116b;
        ...
        Iterator<ZeusPluginStateListener> it = list.iterator();
        while (it.hasNext()) {
            it.next().onStateChangeOnCurThread(TextUtils.isEmpty(str) ? POP3Message.UNKNOWN : str, i2, objArr);
        }
    }
