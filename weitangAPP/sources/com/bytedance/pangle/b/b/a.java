...
public final class a {
    ...
    private static Method f5952a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static Method f5953b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static Method f5954c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static Method f5955d;

    static {
        try {
            f5952a = Class.class.getDeclaredMethod("getDeclaredField", String.class);
            f5953b = Class.class.getDeclaredMethod("getDeclaredMethod", String.class, Class[].class);
            f5954c = Class.class.getDeclaredMethod("getDeclaredConstructor", Class[].class);
            f5955d = Class.class.getDeclaredMethod("forName", String.class);
        } catch (Throwable th) {
