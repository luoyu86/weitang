...
public class ServiceManagerNative {
    ...
    public boolean bindServiceNative(Context context, Intent intent, final ServiceConnection serviceConnection, int i2, String str) {
        ...
        e eVarA = b.a(serviceInfoQueryServiceFromPlugin.processName);
        IBinder iBinderAsBinder = eVarA.asBinder();
        ...
        try {
            return eVarA.a(intent, this.serviceConn2ServiceConn.get(serviceConnection), i2, str);
