...
public class RepairOrderAdapter extends BaseRecyclerAdapter<RepairOrderItemVo> {

    public static class RepairOrderVh extends BaseRecyclerViewHolder<RepairOrderItemVo> {

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        public View.OnClickListener f8223f;
        ...
        public void g(RepairOrderItemVo repairOrderItemVo) {
            int status = repairOrderItemVo.getStatus();
            this.mContactBtn.setVisibility(8);
            this.mContentTv.setText(x.getNotNullStr(repairOrderItemVo.getRepairDesc(), ""));
            this.mAddressTv.setText(x.getNotNullStr(repairOrderItemVo.getAddress(), ""));
            this.mTimeTv.setText(z.getTimeFromTo(repairOrderItemVo.getFromTime(), repairOrderItemVo.getToTime()));
            this.mStateTv.setText(x.getNotNullStr(repairOrderItemVo.getStatusDesc(), ""));
            this.mActionBtn.setVisibility(status != 2 && status != 5 ? 0 : 8);
            this.mActionBtn.setText(status != 4 ? R.string.title_cancel : R.string.title_comment);
            if (status == 3) {
        ...
        public final void h(Button button) {
            ...
            button.setOnClickListener(this.f8223f);
            button.setTag(Integer.valueOf(this.f8224g));
        }

        public void setOnClickListener(View.OnClickListener onClickListener) {
            this.f8223f = onClickListener;
        }
    ...
    public class RepairOrderVh_ViewBinding implements Unbinder {
        ...
        @CallSuper
        public void unbind() {
            RepairOrderVh repairOrderVh = this.f8225b;
    ...
    public RepairOrderAdapter() {
        RepairOrderItemVo repairOrderItemVo = new RepairOrderItemVo();
        repairOrderItemVo.setStatus(34952);
        addDataToList(repairOrderItemVo);
    }
    ...
    public int getItemViewType(int i2) {
        ...
        if (list != 0 && !list.isEmpty() && this.f6460b.size() == 1 && ((RepairOrderItemVo) this.f6460b.get(i2)).getStatus() == 34952 && ((RepairOrderItemVo) this.f6460b.get(i2)).getRepairName() == null) {
            return 34952;
        }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        repairOrderVh.g((RepairOrderItemVo) this.f6460b.get(i2));
    }
