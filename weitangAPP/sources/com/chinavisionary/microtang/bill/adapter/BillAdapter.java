...
public class BillAdapter extends BaseRecyclerAdapter<BillVo> {
    ...
    public static class BillVh extends BaseRecyclerViewHolder<BillVo> {
        ...
        public BillVh(View view) {
            ...
            this.f6858h = view.getResources().getColor(R.color.tab_item_select_color);
            this.f6857g = view.getResources().getColor(R.color.color000000);
        }
        ...
        public void g(BillVo billVo) {
            ...
            this.mPayDateTv.setText(z.getTimeYYMMDD(billVo.getPayDate()));
            this.mBillDateValueTv.setText(x.getString(R.string.placeholder_time_middle_unit, z.getTimeYYMMDD(billVo.getBillPeriodFrom()), z.getTimeYYMMDD(billVo.getBillPeriodTo())));
            ...
            this.mLateFeeTv.setText(x.getString(R.string.placeholder_day_last_fee, String.valueOf(billVo.getLateFeeDays()), x.bigDecimalToPlainString(billVo.getLateFee())));
            boolean z = billVo.getBillStatus() == 0;
            this.mBillDateValueTv.setTextColor(z ? this.f6858h : this.f6857g);
            this.mPayBtn.setVisibility(z ? 0 : 8);
            this.mPayBtn.setOnClickListener(null);
            this.mPayBtn.setOnClickListener(this.f6856f);
    ...
    public class BillVh_ViewBinding implements Unbinder {
        ...
        public BillVh_ViewBinding(BillVh billVh, View view) {
            ...
            billVh.mLateFeeTv = (TextView) d.findRequiredViewAsType(view, R.id.tv_bill_late_price_value, "field 'mLateFeeTv'", TextView.class);
            billVh.mPayDateTv = (TextView) d.findRequiredViewAsType(view, R.id.tv_pay_date_value, "field 'mPayDateTv'", TextView.class);
            billVh.mBillDateValueTv = (TextView) d.findRequiredViewAsType(view, R.id.tv_bill_date_value, "field 'mBillDateValueTv'", TextView.class);
        }

        @Override // butterknife.Unbinder
        @CallSuper
        public void unbind() {
            BillVh billVh = this.f6859b;
            if (billVh == null) {
