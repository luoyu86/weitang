...
public final class FileTypeDetector {
    ...
    static {
        ...
        byteTrie.addPath(FileType.PNG, new byte[]{-119, 80, 78, 71, BaseParser.ASCII_CR, 10, 26, 10, 0, 0, 0, BaseParser.ASCII_CR, 73, 72, 68, 82});
        ...
        byteTrie.addPath(FileType.CR2, "II".getBytes(charset), new byte[]{42, 0, GlyfDescript.X_DUAL, 0, 0, 0, 67, 82});
        byteTrie.addPath(FileType.NEF, "MM".getBytes(charset), new byte[]{0, 42, 0, 0, 0, -128, 0});
