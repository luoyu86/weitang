...
public final class PDFontFactory {
    ...
    public static PDFont createFont(COSDictionary cOSDictionary, ResourceCache resourceCache) throws IOException {
        ...
        COSName cOSName3 = cOSDictionary.getCOSName(cOSName, cOSName2);
        if (!cOSName2.equals(cOSName3)) {
            Log.e("PdfBox-Android", "Expected 'Font' dictionary but found '" + cOSName3.getName() + OperatorName.SHOW_TEXT_LINE);
        }
        COSName cOSName4 = cOSDictionary.getCOSName(COSName.SUBTYPE);
        ...
        if (COSName.MM_TYPE1.equals(cOSName4)) {
        ...
        if (COSName.TRUE_TYPE.equals(cOSName4)) {
