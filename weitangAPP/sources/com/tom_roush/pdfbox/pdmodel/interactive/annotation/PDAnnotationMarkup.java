...
public class PDAnnotationMarkup extends PDAnnotation {
    ...
    public float[][] getInkList() {
        ...
        for (int i2 = 0; i2 < cOSArray.size(); i2++) {
            ...
            if (object instanceof COSArray) {
                fArr[i2] = ((COSArray) object).toFloatArray();
            } else {
                fArr[i2] = new float[0];
            }
        }
    ...
    public void setConstantOpacity(float f2) {
        getCOSObject().setFloat(COSName.CA, f2);
    }
    ...
    public void setQ(int i2) {
        getCOSObject().setInt(COSName.Q, i2);
    }
    ...
    public void constructAppearances(PDDocument pDDocument) {
        ...
        PDAppearanceHandler pDSoundAppearanceHandler = null;
        if ("Caret".equals(getSubtype())) {
            ...
            pDSoundAppearanceHandler = new PDSoundAppearanceHandler(this, pDDocument);
        }
