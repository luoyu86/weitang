...
public class PDTextAppearanceHandler extends PDAbstractAppearanceHandler {
    ...
    private PDRectangle adjustRectAndBBox(PDAnnotationText pDAnnotationText, float f2, float f3) {
        PDRectangle rectangle = getRectangle();
        if (!pDAnnotationText.isNoZoom()) {
            rectangle.setUpperRightX(rectangle.getLowerLeftX() + f2);
            rectangle.setLowerLeftY(rectangle.getUpperRightY() - f3);
    ...
    private void drawCheck(PDAnnotationText pDAnnotationText, PDAppearanceContentStream pDAppearanceContentStream) throws IOException {
        PDRectangle pDRectangleAdjustRectAndBBox = adjustRectAndBBox(pDAnnotationText, 20.0f, 19.0f);
        float fMin = Math.min(pDRectangleAdjustRectAndBBox.getWidth(), pDRectangleAdjustRectAndBBox.getHeight());
        ...
        float f2 = (fMin * 0.001f) / 0.8f;
        pDAppearanceContentStream.transform(Matrix.getScaleInstance(f2, f2));
    ...
    private void drawCircles(PDAnnotationText pDAnnotationText, PDAppearanceContentStream pDAppearanceContentStream) throws IOException {
        PDRectangle pDRectangleAdjustRectAndBBox = adjustRectAndBBox(pDAnnotationText, 20.0f, 20.0f);
        pDAppearanceContentStream.setMiterLimit(4.0f);
        pDAppearanceContentStream.setLineJoinStyle(1);
        pDAppearanceContentStream.setLineCapStyle(0);
        ...
        pDExtendedGraphicsState.setStrokingAlphaConstant(fValueOf);
        pDExtendedGraphicsState.setNonStrokingAlphaConstant(fValueOf);
        ...
        drawCircle(pDAppearanceContentStream, pDRectangleAdjustRectAndBBox.getWidth() / 2.0f, pDRectangleAdjustRectAndBBox.getHeight() / 2.0f, 6.36f);
        pDAppearanceContentStream.fill();
        pDAppearanceContentStream.restoreGraphicsState();
        pDAppearanceContentStream.setLineWidth(0.59f);
        drawCircle(pDAppearanceContentStream, pDRectangleAdjustRectAndBBox.getWidth() / 2.0f, pDRectangleAdjustRectAndBBox.getHeight() / 2.0f, 6.36f);
        drawCircle2(pDAppearanceContentStream, pDRectangleAdjustRectAndBBox.getWidth() / 2.0f, pDRectangleAdjustRectAndBBox.getHeight() / 2.0f, 9.756f);
        pDAppearanceContentStream.fillAndStroke();
    }
    ...
    private void drawCross(PDAnnotationText pDAnnotationText, PDAppearanceContentStream pDAppearanceContentStream) throws IOException {
        PDRectangle pDRectangleAdjustRectAndBBox = adjustRectAndBBox(pDAnnotationText, 19.0f, 19.0f);
        float fMin = Math.min(pDRectangleAdjustRectAndBBox.getWidth(), pDRectangleAdjustRectAndBBox.getHeight());
        float f2 = fMin / 10.0f;
        float f3 = fMin / 5.0f;
        pDAppearanceContentStream.setMiterLimit(4.0f);
        ...
        pDAppearanceContentStream.setLineCapStyle(0);
        pDAppearanceContentStream.setLineWidth(0.59f);
        pDAppearanceContentStream.moveTo(f2, f3);
        pDAppearanceContentStream.lineTo(f3, f2);
        float f4 = fMin / 2.0f;
        float f5 = f4 - f2;
        ...
        float f8 = f4 + f2;
        pDAppearanceContentStream.lineTo(f8, f4);
        pDAppearanceContentStream.lineTo(f7, f6);
        pDAppearanceContentStream.lineTo(f6, f7);
        pDAppearanceContentStream.lineTo(f4, f8);
        pDAppearanceContentStream.lineTo(f3, f7);
        pDAppearanceContentStream.lineTo(f2, f6);
        pDAppearanceContentStream.lineTo(f5, f4);
        pDAppearanceContentStream.closeAndFillAndStroke();
    }
    ...
    private void drawHelp(PDAnnotationText pDAnnotationText, PDAppearanceContentStream pDAppearanceContentStream) throws IOException {
        ...
        float f2 = fMin / 2.0f;
        float f3 = f2 - 1.0f;
        drawCircle2(pDAppearanceContentStream, f2, f2, f3);
        pDAppearanceContentStream.fill();
        pDAppearanceContentStream.restoreGraphicsState();
        pDAppearanceContentStream.saveGraphicsState();
        float f4 = (fMin * 0.001f) / 2.25f;
        pDAppearanceContentStream.transform(Matrix.getScaleInstance(f4, f4));
    ...
    private void drawInsert(PDAnnotationText pDAnnotationText, PDAppearanceContentStream pDAppearanceContentStream) throws IOException {
        PDRectangle pDRectangleAdjustRectAndBBox = adjustRectAndBBox(pDAnnotationText, 17.0f, 20.0f);
        pDAppearanceContentStream.setMiterLimit(4.0f);
        pDAppearanceContentStream.setLineJoinStyle(0);
        pDAppearanceContentStream.setLineCapStyle(0);
        pDAppearanceContentStream.setLineWidth(0.59f);
        pDAppearanceContentStream.moveTo((pDRectangleAdjustRectAndBBox.getWidth() / 2.0f) - 1.0f, pDRectangleAdjustRectAndBBox.getHeight() - 2.0f);
        pDAppearanceContentStream.lineTo(1.0f, 1.0f);
        pDAppearanceContentStream.lineTo(pDRectangleAdjustRectAndBBox.getWidth() - 2.0f, 1.0f);
        pDAppearanceContentStream.closeAndFillAndStroke();
    }
    ...
    private void drawNote(PDAnnotationText pDAnnotationText, PDAppearanceContentStream pDAppearanceContentStream) throws IOException {
        PDRectangle pDRectangleAdjustRectAndBBox = adjustRectAndBBox(pDAnnotationText, 18.0f, 20.0f);
        pDAppearanceContentStream.setMiterLimit(4.0f);
        pDAppearanceContentStream.setLineJoinStyle(1);
        pDAppearanceContentStream.setLineCapStyle(0);
        pDAppearanceContentStream.setLineWidth(0.61f);
        pDAppearanceContentStream.addRect(1.0f, 1.0f, pDRectangleAdjustRectAndBBox.getWidth() - 2.0f, pDRectangleAdjustRectAndBBox.getHeight() - 2.0f);
        pDAppearanceContentStream.moveTo(pDRectangleAdjustRectAndBBox.getWidth() / 4.0f, (pDRectangleAdjustRectAndBBox.getHeight() / 7.0f) * 2.0f);
        pDAppearanceContentStream.lineTo(((pDRectangleAdjustRectAndBBox.getWidth() * 3.0f) / 4.0f) - 1.0f, (pDRectangleAdjustRectAndBBox.getHeight() / 7.0f) * 2.0f);
        pDAppearanceContentStream.moveTo(pDRectangleAdjustRectAndBBox.getWidth() / 4.0f, (pDRectangleAdjustRectAndBBox.getHeight() / 7.0f) * 3.0f);
        pDAppearanceContentStream.lineTo(((pDRectangleAdjustRectAndBBox.getWidth() * 3.0f) / 4.0f) - 1.0f, (pDRectangleAdjustRectAndBBox.getHeight() / 7.0f) * 3.0f);
        pDAppearanceContentStream.moveTo(pDRectangleAdjustRectAndBBox.getWidth() / 4.0f, (pDRectangleAdjustRectAndBBox.getHeight() / 7.0f) * 4.0f);
        pDAppearanceContentStream.lineTo(((pDRectangleAdjustRectAndBBox.getWidth() * 3.0f) / 4.0f) - 1.0f, (pDRectangleAdjustRectAndBBox.getHeight() / 7.0f) * 4.0f);
        pDAppearanceContentStream.moveTo(pDRectangleAdjustRectAndBBox.getWidth() / 4.0f, (pDRectangleAdjustRectAndBBox.getHeight() / 7.0f) * 5.0f);
        pDAppearanceContentStream.lineTo(((pDRectangleAdjustRectAndBBox.getWidth() * 3.0f) / 4.0f) - 1.0f, (pDRectangleAdjustRectAndBBox.getHeight() / 7.0f) * 5.0f);
        pDAppearanceContentStream.fillAndStroke();
    }
    ...
    private void drawParagraph(PDAnnotationText pDAnnotationText, PDAppearanceContentStream pDAppearanceContentStream) throws IOException {
        ...
        pDAppearanceContentStream.restoreGraphicsState();
        pDAppearanceContentStream.fillAndStroke();
        drawCircle(pDAppearanceContentStream, f2, f2, f3);
    ...
    private void drawRightPointer(PDAnnotationText pDAnnotationText, PDAppearanceContentStream pDAppearanceContentStream) throws IOException {
        PDRectangle pDRectangleAdjustRectAndBBox = adjustRectAndBBox(pDAnnotationText, 20.0f, 17.0f);
        float fMin = Math.min(pDRectangleAdjustRectAndBBox.getWidth(), pDRectangleAdjustRectAndBBox.getHeight());
        pDAppearanceContentStream.setMiterLimit(4.0f);
        pDAppearanceContentStream.setLineJoinStyle(1);
        pDAppearanceContentStream.setLineCapStyle(0);
