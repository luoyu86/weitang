        ...
        try {
            try {
                ...
                if (borderEffect == null || !borderEffect.getStyle().equals("C")) {
                    ...
                    normalAppearanceAsContentStream.addRect(pDRectangleHandleBorderBox.getLowerLeftX(), pDRectangleHandleBorderBox.getLowerLeftY(), pDRectangleHandleBorderBox.getWidth(), pDRectangleHandleBorderBox.getHeight());
                } else {
