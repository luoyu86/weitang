...
public class PDFourColours implements COSObjectable {
    ...
    private PDGamma getColourByIndex(int i2) {
        COSBase object = this.array.getObject(i2);
    ...
    private void setColourByIndex(int i2, PDGamma pDGamma) {
        this.array.set(i2, pDGamma == null ? COSNull.NULL : pDGamma.getCOSArray());
    }
