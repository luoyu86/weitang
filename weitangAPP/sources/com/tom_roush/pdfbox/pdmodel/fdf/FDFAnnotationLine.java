...
public class FDFAnnotationLine extends FDFAnnotation {
    ...
    public void setLeaderExtend(float f2) {
        this.annot.setFloat(COSName.LLE, f2);
    }

    public void setLeaderLength(float f2) {
        this.annot.setFloat(COSName.LL, f2);
    }

    public void setLeaderOffset(float f2) {
        this.annot.setFloat(COSName.LLO, f2);
    }
    ...
    public FDFAnnotationLine(Element element) throws IOException {
        super(element);
        this.annot.setName(COSName.SUBTYPE, "Line");
        String attribute = element.getAttribute(RequestBannerParamBo.GET_SPLASH_TYPE);
        if (attribute != null && !attribute.isEmpty()) {
            String attribute2 = element.getAttribute("end");
            if (attribute2 != null && !attribute2.isEmpty()) {
                String[] strArrSplit = (attribute + "," + attribute2).split(",");
