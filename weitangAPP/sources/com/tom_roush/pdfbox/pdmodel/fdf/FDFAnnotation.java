...
public abstract class FDFAnnotation implements COSObjectable {
    ...
    private String richContentsToString(Node node, boolean z) {
        ...
        for (int i2 = 0; i2 < childNodes.getLength(); i2++) {
            ...
            if (nodeItem instanceof Element) {
                sb.append(richContentsToString(nodeItem, false));
            } else if (nodeItem instanceof CDATASection) {
                sb.append("<![CDATA[");
                sb.append(((CDATASection) nodeItem).getData());
                sb.append("]]>");
            } else if (nodeItem instanceof Text) {
                String data = ((Text) nodeItem).getData();
                if (data != null) {
        ...
        for (int i3 = 0; i3 < attributes.getLength(); i3++) {
            ...
            sb2.append(String.format(" %s=\"%s\"", nodeItem2.getNodeName(), nodeValue));
        }
    ...
    public final void setPage(int i2) {
        this.annot.setInt(COSName.PAGE, i2);
    }
        ...
        if (attribute != null && !attribute.isEmpty()) {
            ...
            if (attribute4 != null) {
                ...
                if (strArrSplit.length == 4) {
                    ...
                    String attribute6 = element.getAttribute(MessengerService.INTENT);
