...
public class AWTColor {
    ...
    static {
        ...
        red = aWTColor6;
        RED = aWTColor6;
        AWTColor aWTColor7 = new AWTColor(255, HideBottomViewOnScrollBehavior.EXIT_ANIMATION_DURATION, HideBottomViewOnScrollBehavior.EXIT_ANIMATION_DURATION);
        pink = aWTColor7;
        PINK = aWTColor7;
    ...
    public AWTColor(float f2, float f3, float f4) {
        this.color = Color.rgb((int) (f2 * 255.0f), (int) (f3 * 255.0f), (int) (f4 * 255.0f));
    }
}
