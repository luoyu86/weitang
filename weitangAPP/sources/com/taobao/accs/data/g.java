...
public class g {
    ...
    private static volatile g f10300a;
    ...
    */
    public void b(android.content.Context r29, com.taobao.accs.net.b r30, android.content.Intent r31) {
        /*
    ...
    public boolean a(int i2, String str) {
        if (i2 != 100 && !GlobalClientInfo.AGOO_SERVICE_ID.equals(str)) {
            long jC = UtilityImpl.c();
            if (jC != -1 && jC <= 5242880) {
                AppMonitorAdapter.commitAlarmFail("accs", BaseMonitor.ALARM_POINT_REQ_ERROR, str, "1", "space low " + jC);
                ALog.e("MsgDistribute", "user space low, don't distribute", "size", Long.valueOf(jC), Constants.KEY_SERVICE_ID, str);
                return true;
            }
        }
        return false;
    ...
    public boolean a(Context context, String str, String str2, Intent intent, ArrayList<IAppReceiver> arrayList) {
        try {
    ...
    private void a(Intent intent, String str, int i2, String str2, String str3, String str4, ArrayList<IAppReceiver> arrayList, ErrorCode errorCode) {
        int i3;
        int i4;
        if (ALog.isPrintLog(ALog.Level.D)) {
            ALog.d("MsgDistribute", "handleControlMsg", Constants.KEY_CONFIG_TAG, str, Constants.KEY_DATA_ID, str4, Constants.KEY_SERVICE_ID, str3, "command", Integer.valueOf(i2), "errorCode", errorCode);
            if (arrayList != null) {
                Iterator<IAppReceiver> it = arrayList.iterator();
                while (it.hasNext()) {
        ...
        if (errorCode.getCodeInt() == AccsErrorCode.SUCCESS.getCodeInt() || i2 == 103 || i2 == 101) {
            i3 = 2;
            i4 = 3;
        } else {
            i3 = 2;
            i4 = 3;
            ALog.e("MsgDistribute", "handleControlMsg", "command", Integer.valueOf(i2), "errorCode", errorCode);
        }
        if (arrayList != null) {
            if (i2 == 1) {
        ...
        UTMini.getInstance().commitEvent(66001, "MsgToBuss7", "commandId=" + i2, "serviceId=" + str3 + " errorCode=" + errorCode + " dataId=" + str4, Integer.valueOf(Constants.SDK_VERSION_CODE));
    }
    ...
    public void a(Context context, com.taobao.accs.net.b bVar, ArrayList<IAppReceiver> arrayList, Intent intent, String str, String str2, int i2, ErrorCode errorCode) {
        String service;
        ALog.i("MsgDistribute", "handleBusinessMsg start", Constants.KEY_DATA_ID, str2, Constants.KEY_SERVICE_ID, str, "command", Integer.valueOf(i2));
        if (arrayList != null) {
            Iterator<IAppReceiver> it = arrayList.iterator();
            service = null;
            while (it.hasNext()) {
        ...
        UTMini.getInstance().commitEvent(66001, "MsgToBuss", "commandId=" + i2, "serviceId=" + str + " errorCode=" + errorCode + " dataId=" + str2, Integer.valueOf(Constants.SDK_VERSION_CODE));
    ...
    public void a(Context context, Intent intent, int i2, ErrorCode errorCode) {
        ALog.i("MsgDistribute", "handBroadCastMsg", "command", Integer.valueOf(i2));
        ...
        if (i2 != 103) {
            ...
            if (i2 != 1 && i2 != 2 && i2 != 3 && i2 != 4 && i2 != 5 && i2 != 6) {
                ALog.w("MsgDistribute", "handBroadCastMsg not handled command " + i2, new Object[0]);
                return;
            }
            ALog.d("MsgDistribute", "handBroadCastMsg not handled command " + i2, new Object[0]);
            return;
        }
