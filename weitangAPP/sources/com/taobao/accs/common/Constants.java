...
public class Constants {
    ...
    public static ErrorCode getErrorCode(Intent intent) {
        if (intent.hasExtra(KEY_ERROR_OBJ)) {
            return (ErrorCode) intent.getSerializableExtra(KEY_ERROR_OBJ);
        }
        int intExtra = intent.getIntExtra("errorCode", 0);
        return intExtra == 0 ? AccsErrorCode.SUCCESS : AccsErrorCode.convertNetworkSdkError(intExtra, intent.getStringExtra(KEY_ERROR_DETAIL)).detail(AccsErrorCode.getAllDetails(null)).build();
    }
}
