...
public class d extends com.tianmu.c.c.b<m, NativeExpressAdInfo, NativeExpressAdListener, NativeExpressAd> implements NativeExpressAdListener {
    ...
    public void j() {
        try {
            ...
            ((NativeExpressAd) this.f11236b).requestAdInfo(this);
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    public void onRenderFailed(NativeExpressAdInfo nativeExpressAdInfo, TianmuError tianmuError) {
        ...
        mVar.e(true);
        if (TianmuAdUtil.canCallBack(d())) {
            ((NativeExpressAdListener) ((NativeExpressAd) d()).getListener()).onRenderFailed(nativeExpressAdInfo, tianmuError);
        }
    }
