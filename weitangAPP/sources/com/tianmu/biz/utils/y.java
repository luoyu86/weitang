...
public final class y {
    ...
    public static boolean c() {
        return Build.MANUFACTURER.equalsIgnoreCase("HISENSE") || Build.BRAND.equalsIgnoreCase("HISENSE");
    }

    public static boolean d() {
        if (!Build.MANUFACTURER.equalsIgnoreCase("HUAWEI")) {
            String str = Build.BRAND;
            if (!str.equalsIgnoreCase("HUAWEI") && !str.equalsIgnoreCase("HONOR") && !str.equalsIgnoreCase("HINOVA") && !str.equalsIgnoreCase("NZONE")) {
                return false;
            }
        }
        return true;
        ...
        try {
            if (!d() && !b()) {
                if (!k() && !j()) {
                    ...
                    if (!n() && !g()) {
                        if (c()) {
                            return "cn.hisense.hiphone.appstore";
                        }
                        if (i()) {
