...
public class TaobaoNetworkAdapter implements Serializable {
    ...
    private static void a(String str, String str2, ConnProtocol connProtocol, boolean z, boolean z2) {
        ...
        if (z) {
            if (!z2) {
                ...
                SessionCenter.getInstance(new Config.Builder().setAppkey(str2).setEnv(ENV.ONLINE).build()).get(HttpUrl.parse(StringUtils.concatString("https", HttpConstant.SCHEME_SPLIT, str)), anet.channel.entity.c.f462a, 0L);
            }
        }
    }
    ...
    public static void init(Context context, HashMap<String, Object> map) {
        ...
        if (isInited.compareAndSet(false, true)) {
            ...
            if (map != null && "com.taobao.taobao:channel".equals(map.get("process")) && a.a.o.b.isChannelLocalInstanceEnable()) {
                ALog.e("awcn.TaobaoNetworkAdapter", "channelLocalInstanceEnable", null, new Object[0]);
                a.a.o.b.setRemoteNetworkServiceEnable(false);
            }
            ALog.setLog(new anet.channel.d.a());
            a.a.o.b.setRemoteConfig(new anet.channel.c.a());
                ...
                try {
                    ...
                    if (AgooConstants.TAOBAO_PACKAGE.equals(str)) {
                        if (defaultSharedPreferences.getBoolean("SERVICE_OPTIMIZE", true)) {
                            a.a.o.b.setBindServiceOptimize(true);
