...
public class a implements IFullTraceAnalysis {
    ...
    public void commitRequest(String str, RequestStatistic requestStatistic) {
        if (!this.f365a || requestStatistic == null || TextUtils.isEmpty(str)) {
            return;
        }
    ...
    public anet.channel.fulltrace.b getSceneInfo() {
        ...
        bVar.f472b = SceneIdentifier.isUrlLaunch();
        bVar.f473c = SceneIdentifier.getAppLaunchTime();
        bVar.f474d = SceneIdentifier.getLastLaunchTime();
        bVar.f475e = SceneIdentifier.getDeviceLevel();
        bVar.f471a = SceneIdentifier.getStartType();
        bVar.f476f = SceneIdentifier.getBucketInfo();
        bVar.f477g = ABTestCenter.getUTABTestBucketId("networksdk");
        return bVar;
    }
}
