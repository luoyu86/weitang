...
public class a implements a.a.o.a {
    ...
    public void onConfigUpdate(String str) {
        if ("networkSdk".equals(str)) {
            ...
            try {
                c.a.f634a.a(Boolean.valueOf(getConfig(str, "network_empty_scheme_https_switch", "true")).booleanValue());
            } catch (Exception unused) {
            }
            try {
                a.a.o.b.setSpdyEnabled(Boolean.valueOf(getConfig(str, "network_spdy_enable_switch", "true")).booleanValue());
            } catch (Exception unused2) {
            }
            try {
                a.a.o.b.setHttpCacheEnable(Boolean.valueOf(getConfig(str, "network_http_cache_switch", "true")).booleanValue());
            } catch (Exception unused3) {
            }
            try {
                String config = getConfig(str, "network_http_cache_flag", null);
                if (config != null) {
                    a.a.o.b.setCacheFlag(Long.valueOf(config).longValue());
                }
            ...
            try {
                a.a.o.b.setRequestStatisticSampleRate(Integer.valueOf(getConfig(str, "network_request_statistic_sample_rate", "10000")).intValue());
            } catch (Exception unused7) {
            }
            try {
                String config2 = getConfig(str, "network_request_forbidden_bg", null);
                if (!TextUtils.isEmpty(config2)) {
                    a.a.o.b.setBgRequestForbidden(Boolean.valueOf(config2).booleanValue());
                }
            } catch (Exception unused8) {
            }
            try {
                a.a.o.b.updateWhiteListMap(getConfig(str, "network_url_white_list_bg", null));
            } catch (Exception unused9) {
            }
            try {
                String config3 = getConfig(str, "network_biz_white_list_bg", null);
                if (!TextUtils.isEmpty(config3)) {
                    a.a.o.b.updateBizWhiteList(config3);
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config4)) {
                    a.a.o.b.setAmdcPresetHosts(config4);
                }
            ...
            try {
                a.a.o.b.setResponseBufferEnable(Boolean.valueOf(getConfig(str, "network_response_buffer_switch", "true")).booleanValue());
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config6)) {
                    ...
                    SharedPreferences.Editor editorEdit2 = PreferenceManager.getDefaultSharedPreferences(a.a.r.a.getContext()).edit();
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config7)) {
                    ...
                    a.a.o.b.setBgForbidRequestThreshold(iIntValue);
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config10)) {
                    a.a.o.b.setMonitorRequestList(config10);
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config14)) {
                    a.a.o.b.setDegradeRequestList(config14);
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config15)) {
                    a.a.o.b.setRequestDelayRetryForNoNetwork(Boolean.valueOf(config15).booleanValue());
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config16)) {
                    ...
                    SharedPreferences.Editor editorEdit3 = PreferenceManager.getDefaultSharedPreferences(a.a.r.a.getContext()).edit();
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config17)) {
                    ...
                    SharedPreferences.Editor editorEdit4 = PreferenceManager.getDefaultSharedPreferences(a.a.r.a.getContext()).edit();
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config24)) {
                    a.a.p.a.setTargetMonitorCookieName(config24);
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config26)) {
                    a.a.o.b.setChannelLocalInstanceEnable(Boolean.valueOf(config26).booleanValue());
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config27)) {
                    a.a.o.b.setAllowSpdyWhenBindServiceFailed(Boolean.valueOf(config27).booleanValue());
                }
