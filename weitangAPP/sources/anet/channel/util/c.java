...
public class c {
    ...
    public static volatile String f717b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static f f718c;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final byte[][] f716a = {new byte[]{-64, 0, 0, -86}, new byte[]{-64, 0, 0, -85}};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static ConcurrentHashMap<String, f> f719d = new ConcurrentHashMap<>();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static ConcurrentHashMap<String, Integer> f720e = new ConcurrentHashMap<>();

    static {
        f717b = null;
        f718c = null;
        try {
            f718c = new f((Inet6Address) InetAddress.getAllByName("64:ff9b::")[0], 96);
            f717b = b(NetworkStatusHelper.getStatus());
    ...
    public static f d() {
        f fVar = f719d.get(f717b);
        return fVar == null ? f718c : fVar;
    }
    ...
    public static void e() {
        ...
        f717b = b(NetworkStatusHelper.getStatus());
        if (f720e.putIfAbsent(f717b, 0) != null) {
            return;
        }
        int iJ = j();
        f720e.put(f717b, Integer.valueOf(iJ));
    ...
    public static String a(Inet4Address inet4Address) throws Exception {
        ...
        byte[] address2 = fVarD.f725b.getAddress();
        int i2 = fVarD.f724a / 8;
        int i3 = 0;
        int i4 = 0;
        while (true) {
            int i5 = i3 + i2;
