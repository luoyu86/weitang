...
public class NetworkStatusHelper {
    ...
    public static String getDnsServerAddress() {
        return !b.l.isEmpty() ? b.l.get(0).getHostAddress() : b.f();
    }
    ...
    public static String getProxyType() {
        NetworkStatus networkStatus = b.f583c;
        return (networkStatus != NetworkStatus.WIFI || getWifiProxy() == null) ? (networkStatus.isMobile() && b.f585e.contains("wap")) ? "wap" : (!networkStatus.isMobile() || g.a() == null) ? "" : "auth" : "proxy";
    }
    ...
    public static boolean isConnected() {
        ...
        } else if (b.f583c != NetworkStatus.NO) {
            return true;
        }
        try {
