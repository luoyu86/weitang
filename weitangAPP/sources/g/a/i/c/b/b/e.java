...
public class e extends KeyFactorySpi implements g.a.e.b.d.b {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            try {
                if (!g.a.i.a.e.n.equals((a0) bVar.getPrivateKeyAlgorithm().getAlgorithm())) {
                    throw new InvalidKeySpecException("Unable to recognise OID in McEliece public key");
                }
                g.a.i.a.a aVar = g.a.i.a.a.getInstance(bVar.parsePrivateKey());
                return new a(new g.a.i.b.c.b(aVar.getN(), aVar.getK(), aVar.getField(), aVar.getGoppaPoly(), aVar.getP(), g.b(aVar.getDigest()).getAlgorithmName()));
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            try {
                if (!g.a.i.a.e.n.equals((a0) lVar.getAlgorithm().getAlgorithm())) {
                    throw new InvalidKeySpecException("Unable to recognise OID in McEliece private key");
                }
                g.a.i.a.b bVar = g.a.i.a.b.getInstance(lVar.parsePublicKey());
                return new b(new g.a.i.b.c.c(bVar.getN(), bVar.getT(), bVar.getG(), g.b(bVar.getDigest()).getAlgorithmName()));
            } catch (IOException e2) {
    ...
    public PrivateKey generatePrivate(g.a.a.t3.b bVar) throws IOException {
        g.a.i.a.a aVar = g.a.i.a.a.getInstance(bVar.parsePrivateKey().toASN1Primitive());
        return new a(new g.a.i.b.c.b(aVar.getN(), aVar.getK(), aVar.getField(), aVar.getGoppaPoly(), aVar.getP(), null));
    }
