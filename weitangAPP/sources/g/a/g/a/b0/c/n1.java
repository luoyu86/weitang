...
public class n1 extends i.b {
    public n1(g.a.g.a.e eVar, g.a.g.a.f fVar, g.a.g.a.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public n1(g.a.g.a.e eVar, g.a.g.a.f fVar, g.a.g.a.f fVar2, g.a.g.a.f[] fVarArr) {
    ...
    public g.a.g.a.i add(g.a.g.a.i iVar) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (fVarAddOne.isZero()) {
                return new n1(curve, fVarAddOne, curve.getB().sqrt());
            }
            ...
            if (fVarMultiply7.isZero()) {
                return new n1(curve, fVarMultiply7, curve.getB().sqrt());
            }
        ...
        return new n1(curve, fVarAddOne, fVarAdd, new g.a.g.a.f[]{fVarFromBigInteger});
    }
    ...
    public g.a.g.a.i negate() {
        ...
        g.a.g.a.f fVar2 = this.f14128d;
        g.a.g.a.f fVar3 = this.f14129e[0];
        return new n1(this.f14126b, fVar, fVar2.add(fVar3), new g.a.g.a.f[]{fVar3});
    }
    ...
    public g.a.g.a.i twice() {
        ...
        g.a.g.a.f fVarAdd = fVar.square().add(fVarMultiply2).add(fVarSquare);
        if (fVarAdd.isZero()) {
            return new n1(curve, fVarAdd, curve.getB().sqrt());
        }
        ...
        return new n1(curve, fVarSquare2, fVarMultiply.squarePlusProduct(fVarAdd, fVarMultiply2).add(fVarSquare2).add(fVarMultiply3), new g.a.g.a.f[]{fVarMultiply3});
    }
    ...
    public g.a.g.a.i twicePlus(g.a.g.a.i iVar) {
        ...
        if (fVarMultiplyPlusProduct.isZero()) {
            return new n1(curve, fVarMultiplyPlusProduct, curve.getB().sqrt());
        }
        ...
        return new n1(curve, fVarMultiply2, fVarMultiplyPlusProduct.add(fVarSquare4).square().multiplyPlusProduct(fVarAdd, rawYCoord.addOne(), fVarMultiply3), new g.a.g.a.f[]{fVarMultiply3});
    }
}
