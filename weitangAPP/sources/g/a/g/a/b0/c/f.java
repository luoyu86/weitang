...
public class f extends i.c {
    ...
    public g.a.g.a.i negate() {
        return isInfinity() ? this : new f(this.f14126b, this.f14127c, this.f14128d.negate(), this.f14129e);
    }
    ...
    public g.a.g.a.i twice() {
        ...
        int[] iArrCreate = g.a.g.c.e.create();
        l.square(mVar.f13991h, iArrCreate);
        int[] iArrCreate2 = g.a.g.c.e.create();
        l.square(iArrCreate, iArrCreate2);
        int[] iArrCreate3 = g.a.g.c.e.create();
        l.square(mVar2.f13991h, iArrCreate3);
        l.reduce32(g.a.g.c.e.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        l.multiply(iArrCreate, mVar2.f13991h, iArrCreate);
        l.reduce32(g.a.g.c.n.shiftUpBits(5, iArrCreate, 2, 0), iArrCreate);
        int[] iArrCreate4 = g.a.g.c.e.create();
        l.reduce32(g.a.g.c.n.shiftUpBits(5, iArrCreate2, 3, 0, iArrCreate4), iArrCreate4);
        m mVar4 = new m(iArrCreate2);
        l.square(iArrCreate3, mVar4.f13991h);
        int[] iArr = mVar4.f13991h;
        l.subtract(iArr, iArrCreate, iArr);
        int[] iArr2 = mVar4.f13991h;
        l.subtract(iArr2, iArrCreate, iArr2);
        m mVar5 = new m(iArrCreate);
        l.subtract(iArrCreate, mVar4.f13991h, mVar5.f13991h);
        int[] iArr3 = mVar5.f13991h;
        l.multiply(iArr3, iArrCreate3, iArr3);
        int[] iArr4 = mVar5.f13991h;
        l.subtract(iArr4, iArrCreate4, iArr4);
        m mVar6 = new m(iArrCreate3);
        l.twice(mVar.f13991h, mVar6.f13991h);
        if (!mVar3.isOne()) {
            int[] iArr5 = mVar6.f13991h;
            l.multiply(iArr5, mVar3.f13991h, iArr5);
        }
