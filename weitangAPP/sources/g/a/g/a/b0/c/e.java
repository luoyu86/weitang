...
public class e extends e.c {
    ...
    public static final BigInteger f13933i = m.f13990g;
    ...
    public class a extends g.a.g.a.a {
        ...
        public final g.a.g.a.i a(int[] iArr, int[] iArr2) {
            return e.this.f(new m(iArr), new m(iArr2), e.j);
        }
        ...
        public g.a.g.a.i lookup(int i2) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < this.f13934a; i4++) {
                int i5 = ((i4 ^ i2) - 1) >> 31;
                for (int i6 = 0; i6 < 5; i6++) {
                    int i7 = iArrCreate[i6];
                    int[] iArr = this.f13935b;
    ...
    public e() {
        super(f13933i);
        this.k = new f(this, null, null);
        this.f14097b = fromBigInteger(g.a.g.a.d.f14090a);
        this.f14098c = fromBigInteger(BigInteger.valueOf(7L));
        this.f14099d = new BigInteger(1, g.a.j.r.c.decodeStrict("0100000000000000000001B8FA16DFAB9ACA16B6B3"));
