...
public class j1 extends i.b {
    public j1(g.a.g.a.e eVar, g.a.g.a.f fVar, g.a.g.a.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public j1(g.a.g.a.e eVar, g.a.g.a.f fVar, g.a.g.a.f fVar2, g.a.g.a.f[] fVarArr) {
    ...
    public g.a.g.a.i add(g.a.g.a.i iVar) {
        ...
        g.a.g.a.f fVarAdd2 = fVarMultiply3.add(fVarMultiply2);
        g.a.g.a.f fVarAdd3 = fVarMultiply4.add(fVarMultiply);
        if (fVarAdd3.isZero()) {
            return fVarAdd2.isZero() ? twice() : curve.getInfinity();
        }
        if (rawXCoord.isZero()) {
            ...
            fVarAddOne = fVarDivide.square().add(fVarDivide).add(xCoord).addOne();
            if (fVarAddOne.isZero()) {
                return new j1(curve, fVarAddOne, curve.getB());
            }
            fVarAdd = fVarDivide.multiply(xCoord.add(fVarAddOne)).add(fVarAddOne).add(yCoord).divide(fVarAddOne).add(fVarAddOne);
            fVarFromBigInteger = curve.fromBigInteger(g.a.g.a.d.f14091b);
        } else {
            g.a.g.a.f fVarSquare = fVarAdd3.square();
            g.a.g.a.f fVarMultiply5 = fVarAdd2.multiply(fVarMultiply4);
            g.a.g.a.f fVarMultiply6 = fVarAdd2.multiply(fVarMultiply);
            g.a.g.a.f fVarMultiply7 = fVarMultiply5.multiply(fVarMultiply6);
            if (fVarMultiply7.isZero()) {
                return new j1(curve, fVarMultiply7, curve.getB());
            }
            g.a.g.a.f fVarMultiply8 = fVarAdd2.multiply(fVarSquare);
            ...
            fVarAddOne = fVarMultiply7;
            fVarFromBigInteger = fVarMultiply9;
            fVarAdd = fVarSquarePlusProduct;
        }
        return new j1(curve, fVarAddOne, fVarAdd, new g.a.g.a.f[]{fVarFromBigInteger});
    }
    ...
    public g.a.g.a.i negate() {
        ...
        g.a.g.a.f fVar2 = this.f14128d;
        g.a.g.a.f fVar3 = this.f14129e[0];
        return new j1(this.f14126b, fVar, fVar2.add(fVar3), new g.a.g.a.f[]{fVar3});
    }
    ...
    public g.a.g.a.i twice() {
        ...
        g.a.g.a.f fVarMultiply = zIsOne ? fVar2 : fVar2.multiply(fVarSquare);
        if (!zIsOne) {
            fVarSquare = fVarSquare.square();
        }
        g.a.g.a.f fVarAdd = fVar2.square().add(fVarMultiply).add(fVarSquare);
        if (fVarAdd.isZero()) {
            return new j1(curve, fVarAdd, curve.getB());
        }
        g.a.g.a.f fVarSquare2 = fVarAdd.square();
        g.a.g.a.f fVarMultiply2 = zIsOne ? fVarAdd : fVarAdd.multiply(fVarSquare);
        g.a.g.a.f fVarSquare3 = fVar2.add(fVar).square();
        return new j1(curve, fVarSquare2, fVarSquare3.add(fVarAdd).add(fVarSquare).multiply(fVarSquare3).add(fVarSquare2), new g.a.g.a.f[]{fVarMultiply2});
    }
    ...
    public g.a.g.a.i twicePlus(g.a.g.a.i iVar) {
        ...
        g.a.g.a.f fVarAdd = fVarSquare3.add(fVarSquare2).add(fVar2.multiply(fVar3));
        g.a.g.a.f fVarMultiplyPlusProduct = rawYCoord.multiply(fVarSquare3).add(fVarSquare2).multiplyPlusProduct(fVarAdd, fVarSquare, fVarSquare3);
        ...
        if (fVarMultiplyPlusProduct.isZero()) {
            return new j1(curve, fVarMultiplyPlusProduct, curve.getB());
        }
        ...
        return new j1(curve, fVarMultiply2, fVarMultiplyPlusProduct.add(fVarSquare4).square().multiplyPlusProduct(fVarAdd, rawYCoord.addOne(), fVarMultiply3), new g.a.g.a.f[]{fVarMultiply3});
    }
}
