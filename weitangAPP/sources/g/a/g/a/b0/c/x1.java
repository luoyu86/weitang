...
public class x1 extends i.b {
    public x1(g.a.g.a.e eVar, g.a.g.a.f fVar, g.a.g.a.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    public x1(g.a.g.a.e eVar, g.a.g.a.f fVar, g.a.g.a.f fVar2, g.a.g.a.f[] fVarArr) {
    ...
    public g.a.g.a.i add(g.a.g.a.i iVar) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (fVarAdd.isZero()) {
                return new x1(curve, fVarAdd, curve.getB());
            }
            ...
            if (fVarMultiply7.isZero()) {
                return new x1(curve, fVarMultiply7, curve.getB());
            }
        ...
        return new x1(curve, fVarAdd, fVarAdd2, new g.a.g.a.f[]{fVarFromBigInteger});
    }
    ...
    public g.a.g.a.i negate() {
        ...
        g.a.g.a.f fVar2 = this.f14128d;
        g.a.g.a.f fVar3 = this.f14129e[0];
        return new x1(this.f14126b, fVar, fVar2.add(fVar3), new g.a.g.a.f[]{fVar3});
    }
    ...
    public g.a.g.a.i twice() {
        ...
        return new x1(curve, fVarSquare3, fVarSquare4.add(fVarAdd).add(fVarSquare2).multiply(fVarSquare4).add(fVarSquare).add(fVarSquare3).add(fVarMultiply), new g.a.g.a.f[]{fVarMultiply});
    }
    ...
    public g.a.g.a.i twicePlus(g.a.g.a.i iVar) {
        ...
        if (fVarMultiplyPlusProduct.isZero()) {
            return new x1(curve, fVarMultiplyPlusProduct, curve.getB());
        }
        ...
        return new x1(curve, fVarMultiply2, fVarMultiplyPlusProduct.add(fVarSquare4).square().multiplyPlusProduct(fVarAdd, fVarAddOne, fVarMultiply3), new g.a.g.a.f[]{fVarMultiply3});
    }
}
