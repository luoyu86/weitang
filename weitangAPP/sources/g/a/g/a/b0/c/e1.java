...
public class e1 extends e.b {
    ...
    public class a extends g.a.g.a.a {
        ...
        public final /* synthetic */ long[] f13942b;
        ...
        public final g.a.g.a.i a(long[] jArr, long[] jArr2) {
            return e1.this.f(new b1(jArr), new b1(jArr2), e1.j);
        }
        ...
        public g.a.g.a.i lookup(int i2) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < this.f13941a; i4++) {
                long j = ((i4 ^ i2) - 1) >> 31;
                for (int i5 = 0; i5 < 3; i5++) {
                    long j2 = jArrCreate64[i5];
                    long[] jArr = this.f13942b;
    ...
    public e1() {
        super(131, 2, 3, 8);
        this.k = new f1(this, null, null);
        this.f14097b = fromBigInteger(new BigInteger(1, g.a.j.r.c.decodeStrict("03E5A88919D7CAFCBF415F07C2176573B2")));
        this.f14098c = fromBigInteger(new BigInteger(1, g.a.j.r.c.decodeStrict("04B8266A46C55657AC734CE38F018F2192")));
        this.f14099d = new BigInteger(1, g.a.j.r.c.decodeStrict("0400000000000000016954A233049BA98F"));
