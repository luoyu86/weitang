...
public class s1 extends e.b {
    ...
    public class a extends g.a.g.a.a {
        ...
        public final g.a.g.a.i a(long[] jArr, long[] jArr2) {
            return s1.this.f(new p1(jArr), new p1(jArr2), s1.j);
        }
        ...
        public g.a.g.a.i lookup(int i2) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < this.f14036a; i4++) {
                long j = ((i4 ^ i2) - 1) >> 31;
                for (int i5 = 0; i5 < 4; i5++) {
                    long j2 = jArrCreate64[i5];
                    long[] jArr = this.f14037b;
        ...
        public g.a.g.a.i lookupVar(int i2) {
            ...
            for (int i4 = 0; i4 < 4; i4++) {
                long j = jArrCreate64[i4];
                long[] jArr = this.f14037b;
                jArrCreate64[i4] = j ^ jArr[i3 + i4];
                jArrCreate642[i4] = jArrCreate642[i4] ^ jArr[(i3 + 4) + i4];
            }
            return a(jArrCreate64, jArrCreate642);
        }
    }
    ...
    public s1() {
        super(193, 15, 0, 0);
        this.k = new t1(this, null, null);
        this.f14097b = fromBigInteger(new BigInteger(1, g.a.j.r.c.decodeStrict("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B")));
        this.f14098c = fromBigInteger(new BigInteger(1, g.a.j.r.c.decodeStrict("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE")));
        this.f14099d = new BigInteger(1, g.a.j.r.c.decodeStrict("010000000000000000000000015AAB561B005413CCD4EE99D5"));
