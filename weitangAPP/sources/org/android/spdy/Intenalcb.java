...
public interface Intenalcb {
    ...
    void spdyDataChunkRecvCB(SpdySession spdySession, boolean z, long j, SpdyByteArray spdyByteArray, int i2);

    void spdyDataRecvCallback(SpdySession spdySession, boolean z, long j, int i2, int i3);

    void spdyDataSendCallback(SpdySession spdySession, boolean z, long j, int i2, int i3);

    void spdyOnStreamResponse(SpdySession spdySession, long j, Map<String, List<String>> map, int i2);

    void spdyPingRecvCallback(SpdySession spdySession, long j, Object obj);

    void spdyRequestRecvCallback(SpdySession spdySession, long j, int i2);
    ...
    void spdyStreamCloseCallback(SpdySession spdySession, long j, int i2, int i3, SuperviseData superviseData);
}
