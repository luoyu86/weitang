...
public final class SpdySessionCallBack implements Intenalcb {
    ...
    @Override // org.android.spdy.Intenalcb
    public void spdyDataChunkRecvCB(SpdySession spdySession, boolean z, long j, SpdyByteArray spdyByteArray, int i2) {
        Spdycb spdycb;
    ...
    @Override // org.android.spdy.Intenalcb
    public void spdyDataRecvCallback(SpdySession spdySession, boolean z, long j, int i2, int i3) {
        Spdycb spdycb;
        ...
        if (spdyStream == null || (spdycb = spdyStream.callBack) == null) {
            ...
            spdycb.spdyDataRecvCallback(spdySession, z, j, i2, spdyStream.streamContext);
        }
        NetTimeGaurd.end("spdyDataRecvCallback", 3, jBegin);
    }

    @Override // org.android.spdy.Intenalcb
    public void spdyDataSendCallback(SpdySession spdySession, boolean z, long j, int i2, int i3) {
        Spdycb spdycb;
        ...
        if (spdyStream == null || (spdycb = spdyStream.callBack) == null) {
            ...
            spdycb.spdyDataSendCallback(spdySession, z, j, i2, spdyStream.streamContext);
        }
    }

    @Override // org.android.spdy.Intenalcb
    public void spdyOnStreamResponse(SpdySession spdySession, long j, Map<String, List<String>> map, int i2) {
        Spdycb spdycb;
    ...
    @Override // org.android.spdy.Intenalcb
    public void spdyRequestRecvCallback(SpdySession spdySession, long j, int i2) {
        Spdycb spdycb;
    ...
    @Override // org.android.spdy.Intenalcb
    public void spdyStreamCloseCallback(SpdySession spdySession, long j, int i2, int i3, SuperviseData superviseData) {
        ...
        if (spdyStream == null || spdyStream.callBack == null) {
            ...
            spdyStream.callBack.spdyStreamCloseCallback(spdySession, j, i2, spdyStream.streamContext, superviseData);
