...
public class b {
    ...
    public static final Object f14993a = new a(0);
    ...
    public b(Map map) {
        this.f14994b = map == null ? new HashMap() : map;
    }
    ...
    public b(c cVar) throws JSONException {
        ...
        while (true) {
            ...
            if (objD != null) {
                b(objD);
                this.f14994b.put(string, objD);
            } else {
                this.f14994b.remove(string);
            }
            char c4 = cVar.c();
            if (c4 != ',' && c4 != ';') {
                if (c4 != '}') {
    ...
    */
    ...
    public final Object a(String str) throws JSONException {
        Object obj = str == null ? null : this.f14994b.get(str);
        if (obj != null) {
            return obj;
        }
    ...
    public final Iterator a() {
        return this.f14994b.keySet().iterator();
    }

    public final boolean b(String str) {
        return this.f14994b.containsKey(str);
    }
    ...
    public String toString() {
        try {
            ...
            while (itA.hasNext()) {
                ...
                stringBuffer.append(':');
                stringBuffer.append(a(this.f14994b.get(next)));
            }
            stringBuffer.append('}');
