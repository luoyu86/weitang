...
public class CircleImageView extends ImageView {
    ...
    private boolean inTouchableArea(float f2, float f3) {
        return Math.pow((double) (f2 - this.mBorderRect.centerX()), 2.0d) + Math.pow((double) (f3 - this.mBorderRect.centerY()), 2.0d) <= Math.pow((double) this.mBorderRadius, 2.0d);
    }
    ...
    public CircleImageView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.mCircleBackgroundColor = typedArrayObtainStyledAttributes.getColor(R.styleable.CircleImageView_civ_circle_background_color, 0);
