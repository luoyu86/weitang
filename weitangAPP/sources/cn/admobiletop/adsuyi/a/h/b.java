...
public class b extends a {
    ...
    public Map<String, Object> a() {
        ...
        if (!TextUtils.isEmpty(appId) && context != null) {
            ...
            map.put("oaid", k.d().h());
            map.put(DispatchConstants.ANDROID, k.d().b(context));
            map.put("mac", k.d().e(context));
            map.put(Constants.KEY_IMEI, k.d().c(context));
        }
        return map;
    }
    ...
    @Override // cn.admobiletop.adsuyi.a.h.a
    public String c() {
        return cn.admobiletop.adsuyi.a.m.p.a().b();
    }
}
